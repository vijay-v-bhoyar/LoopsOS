...
- Loop number: 67
- Loop name: Agent Planning Quality Loop
- Category: 10. Agentic AI Execution and Orchestration
- Skill ID: `loop-067-agent-planning-quality-loop`
- Version: `1.0`
...
- Minimum cadence: Every material workflow change and continuous sampling
...
Outcome to improve: Planning score and corrected planning strategy.

Primary measurable outcome: Planning score and corrected planning strategy.

Business value: Improves confidence, speed, safety, and accountability for Agent Planning Quality Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Agent Planning Quality Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Agentic AI Execution and Orchestration control point for Agent Planning Quality Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Agent Planning Quality Loop`.
...
New agent workflow, planning failure, or sampled production run.
...
- Trigger condition: New agent workflow, planning failure, or sampled production run.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-067-agent-planning-quality-loop:<asset-or-scope>:<trigger-signature>`
...
Evaluate decomposition, ordering, dependencies, assumptions, risks, unnecessary actions, stopping conditions, and recovery paths; improve planning prompts or policies and retest.

## Output

Planning score and corrected planning strategy.
...
- Loop record for `loop-067-agent-planning-quality-loop`
...
- Current state metric: To be measured for `Agent Planning Quality Loop`
...
- Metric: Primary measurable outcome for `Agent Planning Quality Loop`
...
Minimum frequency: Every material workflow change and continuous sampling
...
```yaml
loop_id: "loop-067-agent-planning-quality-loop"
name: "Agent Planning Quality Loop"
version: "1.0"
...
- Loop: Agent Planning Quality Loop
- Outcome: Planning score and corrected planning strategy.
- Trigger: New agent workflow, planning failure, or sampled production run.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
