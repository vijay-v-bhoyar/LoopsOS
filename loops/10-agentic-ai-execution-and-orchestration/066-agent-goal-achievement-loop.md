...
- Loop number: 66
- Loop name: Agent Goal Achievement Loop
- Category: 10. Agentic AI Execution and Orchestration
- Skill ID: `loop-066-agent-goal-achievement-loop`
- Version: `1.0`
...
- Minimum cadence: Every agent task
...
Outcome to improve: Verified result, execution trace, and completion evidence.

Primary measurable outcome: Verified result, execution trace, and completion evidence.

Business value: Improves confidence, speed, safety, and accountability for Agent Goal Achievement Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Agent Goal Achievement Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Agentic AI Execution and Orchestration control point for Agent Goal Achievement Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Agent Goal Achievement Loop`.
...
- Trigger condition: Agent receives an objective.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-066-agent-goal-achievement-loop:<asset-or-scope>:<trigger-signature>`
...
Interpret the goal, constraints, authority, and success conditions; build a plan; execute actions; observe results; evaluate progress; replan; and stop, complete, or escalate.

## Output

Verified result, execution trace, and completion evidence.
...
- Loop record for `loop-066-agent-goal-achievement-loop`
...
- Current state metric: To be measured for `Agent Goal Achievement Loop`
...
- Metric: Primary measurable outcome for `Agent Goal Achievement Loop`
...
Minimum frequency: Every agent task
...
```yaml
loop_id: "loop-066-agent-goal-achievement-loop"
name: "Agent Goal Achievement Loop"
version: "1.0"
...
- Loop: Agent Goal Achievement Loop
- Outcome: Verified result, execution trace, and completion evidence.
- Trigger: Agent receives an objective.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
