...
- Loop number: 68
- Loop name: Tool Selection Loop
- Category: 10. Agentic AI Execution and Orchestration
- Skill ID: `loop-068-tool-selection-loop`
- Version: `1.0`
...
- Minimum cadence: Every proposed tool action
...
Outcome to improve: Authorized tool choice and rationale.

Primary measurable outcome: Authorized tool choice and rationale.

Business value: Improves confidence, speed, safety, and accountability for Tool Selection Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Tool Selection Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Agentic AI Execution and Orchestration control point for Tool Selection Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Tool Selection Loop`.
...
Agent determines that an external capability may be required.
...
- Trigger condition: Agent determines that an external capability may be required.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-068-tool-selection-loop:<asset-or-scope>:<trigger-signature>`
...
Match intent to approved tools, schemas, permissions, data sensitivity, cost, reversibility, and risk; select the safest suitable tool or decline tool use.

## Output

Authorized tool choice and rationale.
...
- Loop record for `loop-068-tool-selection-loop`
...
- Current state metric: To be measured for `Tool Selection Loop`
...
- Metric: Primary measurable outcome for `Tool Selection Loop`
...
Minimum frequency: Every proposed tool action
...
```yaml
loop_id: "loop-068-tool-selection-loop"
name: "Tool Selection Loop"
version: "1.0"
...
- Loop: Tool Selection Loop
- Outcome: Authorized tool choice and rationale.
- Trigger: Agent determines that an external capability may be required.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
