...
- Loop number: 76
- Loop name: Agent Delegation and Accountability Loop
- Category: 10. Agentic AI Execution and Orchestration
- Skill ID: `loop-076-agent-delegation-and-accountability-loop`
- Version: `1.0`
...
- Minimum cadence: Every delegation
...
Outcome to improve: Enforceable delegation record and accountability trail.

Primary measurable outcome: Enforceable delegation record and accountability trail.

Business value: Improves confidence, speed, safety, and accountability for Agent Delegation and Accountability Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Agent Delegation and Accountability Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Agentic AI Execution and Orchestration control point for Agent Delegation and Accountability Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Agent Delegation and Accountability Loop`.
...
Human or agent delegates authority or work to another agent.
...
- Trigger condition: Human or agent delegates authority or work to another agent.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-076-agent-delegation-and-accountability-loop:<asset-or-scope>:<trigger-signature>`
...
Record delegator, delegatee, permitted scope, data, tools, duration, limits, downstream delegation, and accountable human; prevent authority expansion beyond the original grant.

## Output

Enforceable delegation record and accountability trail.
...
- Loop record for `loop-076-agent-delegation-and-accountability-loop`
...
- Current state metric: To be measured for `Agent Delegation and Accountability Loop`
...
- Metric: Primary measurable outcome for `Agent Delegation and Accountability Loop`
...
Minimum frequency: Every delegation
...
```yaml
loop_id: "loop-076-agent-delegation-and-accountability-loop"
name: "Agent Delegation and Accountability Loop"
version: "1.0"
...
- Loop: Agent Delegation and Accountability Loop
- Outcome: Enforceable delegation record and accountability trail.
- Trigger: Human or agent delegates authority or work to another agent.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
