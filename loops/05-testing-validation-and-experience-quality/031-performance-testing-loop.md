...
- Loop number: 31
- Loop name: Performance Testing Loop
- Category: 5. Testing, Validation and Experience Quality
- Skill ID: `loop-031-performance-testing-loop`
- Version: `1.0`
...
- Minimum cadence: Major change and release
...
Outcome to improve: Performance report, capacity recommendation, and tuning backlog.

Primary measurable outcome: Performance report, capacity recommendation, and tuning backlog.

Business value: Improves confidence, speed, safety, and accountability for Performance Testing Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Performance Testing Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Testing, Validation and Experience Quality control point for Performance Testing Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Performance Testing Loop`.
...
Significant implementation, architecture, infrastructure, database, or model change.
...
- Trigger condition: Significant implementation, architecture, infrastructure, database, or model change.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-031-performance-testing-loop:<asset-or-scope>:<trigger-signature>`
...
Execute load, stress, spike, endurance, concurrency, and scalability tests; measure latency, throughput, error rate, and resource use; identify bottlenecks.

## Output

Performance report, capacity recommendation, and tuning backlog.
...
- Loop record for `loop-031-performance-testing-loop`
...
- Current state metric: To be measured for `Performance Testing Loop`
...
- Metric: Primary measurable outcome for `Performance Testing Loop`
...
Minimum frequency: Major change and release
...
```yaml
loop_id: "loop-031-performance-testing-loop"
name: "Performance Testing Loop"
version: "1.0"
...
- Loop: Performance Testing Loop
- Outcome: Performance report, capacity recommendation, and tuning backlog.
- Trigger: Significant implementation, architecture, infrastructure, database, or model change.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
