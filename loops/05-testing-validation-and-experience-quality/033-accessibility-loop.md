...
- Loop number: 33
- Loop name: Accessibility Loop
- Category: 5. Testing, Validation and Experience Quality
- Skill ID: `loop-033-accessibility-loop`
- Version: `1.0`
...
- Minimum cadence: Every UI change and release
...
Outcome to improve: Accessibility results, defects, exceptions, and conformance evidence.

Primary measurable outcome: Accessibility results, defects, exceptions, and conformance evidence.

Business value: Improves confidence, speed, safety, and accountability for Accessibility Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Accessibility Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Testing, Validation and Experience Quality control point for Accessibility Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Accessibility Loop`.
...
New or changed user interface, interaction, document, or customer journey.
...
- Trigger condition: New or changed user interface, interaction, document, or customer journey.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-033-accessibility-loop:<asset-or-scope>:<trigger-signature>`
...
Perform automated and manual checks for keyboard use, screen readers, labels, focus, structure, contrast, alternatives, and understandable errors.

## Output

Accessibility results, defects, exceptions, and conformance evidence.
...
- Loop record for `loop-033-accessibility-loop`
...
- Current state metric: To be measured for `Accessibility Loop`
...
- Metric: Primary measurable outcome for `Accessibility Loop`
...
Minimum frequency: Every UI change and release
...
```yaml
loop_id: "loop-033-accessibility-loop"
name: "Accessibility Loop"
version: "1.0"
...
- Loop: Accessibility Loop
- Outcome: Accessibility results, defects, exceptions, and conformance evidence.
- Trigger: New or changed user interface, interaction, document, or customer journey.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
