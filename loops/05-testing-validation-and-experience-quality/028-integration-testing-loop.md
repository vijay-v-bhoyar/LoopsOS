...
- Loop number: 28
- Loop name: Integration Testing Loop
- Category: 5. Testing, Validation and Experience Quality
- Skill ID: `loop-028-integration-testing-loop`
- Version: `1.0`
...
- Minimum cadence: Every relevant merge or build
...
Outcome to improve: Passing integration suite and verified interface contracts.

Primary measurable outcome: Passing integration suite and verified interface contracts.

Business value: Improves confidence, speed, safety, and accountability for Integration Testing Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Integration Testing Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Testing, Validation and Experience Quality control point for Integration Testing Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Integration Testing Loop`.
...
Change to service, database, API, queue, file, event, or external integration.
...
- Trigger condition: Change to service, database, API, queue, file, event, or external integration.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-028-integration-testing-loop:<asset-or-scope>:<trigger-signature>`
...
Validate contracts, data transformation, authentication, timeout, retry, failure handling, and reconciliation across participating components.

## Output

Passing integration suite and verified interface contracts.
...
- Loop record for `loop-028-integration-testing-loop`
...
- Current state metric: To be measured for `Integration Testing Loop`
...
- Metric: Primary measurable outcome for `Integration Testing Loop`
...
Minimum frequency: Every relevant merge or build
...
```yaml
loop_id: "loop-028-integration-testing-loop"
name: "Integration Testing Loop"
version: "1.0"
...
- Loop: Integration Testing Loop
- Outcome: Passing integration suite and verified interface contracts.
- Trigger: Change to service, database, API, queue, file, event, or external integration.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
