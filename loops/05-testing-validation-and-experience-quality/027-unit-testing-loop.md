...
- Loop number: 27
- Loop name: Unit Testing Loop
- Category: 5. Testing, Validation and Experience Quality
- Skill ID: `loop-027-unit-testing-loop`
- Version: `1.0`
...
- Minimum cadence: Every commit or build
...
Outcome to improve: Passing unit suite and coverage evidence.

Primary measurable outcome: Passing unit suite and coverage evidence.

Business value: Improves confidence, speed, safety, and accountability for Unit Testing Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Unit Testing Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Testing, Validation and Experience Quality control point for Unit Testing Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Unit Testing Loop`.
...
Function, class, module, or component change.
...
- Trigger condition: Function, class, module, or component change.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-027-unit-testing-loop:<asset-or-scope>:<trigger-signature>`
...
Derive positive, negative, boundary, and error cases; execute tests; measure coverage and test strength; fix failures.

## Output

Passing unit suite and coverage evidence.
...
- Loop record for `loop-027-unit-testing-loop`
...
- Current state metric: To be measured for `Unit Testing Loop`
...
- Metric: Primary measurable outcome for `Unit Testing Loop`
...
Minimum frequency: Every commit or build
...
```yaml
loop_id: "loop-027-unit-testing-loop"
name: "Unit Testing Loop"
version: "1.0"
...
- Loop: Unit Testing Loop
- Outcome: Passing unit suite and coverage evidence.
- Trigger: Function, class, module, or component change.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
