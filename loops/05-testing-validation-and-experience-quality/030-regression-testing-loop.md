...
- Loop number: 30
- Loop name: Regression Testing Loop
- Category: 5. Testing, Validation and Experience Quality
- Skill ID: `loop-030-regression-testing-loop`
- Version: `1.0`
...
- Minimum cadence: Every merge and release
...
Outcome to improve: Regression confidence result and release-blocking findings.

Primary measurable outcome: Regression confidence result and release-blocking findings.

Business value: Improves confidence, speed, safety, and accountability for Regression Testing Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Regression Testing Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Testing, Validation and Experience Quality control point for Regression Testing Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Regression Testing Loop`.
...
Code, configuration, infrastructure, model, data, or dependency change.
...
- Trigger condition: Code, configuration, infrastructure, model, data, or dependency change.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-030-regression-testing-loop:<asset-or-scope>:<trigger-signature>`
...
Select an impact-based regression set, execute it, compare with approved baseline, triage failures, and rerun after corrections.

## Output

Regression confidence result and release-blocking findings.
...
- Loop record for `loop-030-regression-testing-loop`
...
- Current state metric: To be measured for `Regression Testing Loop`
...
- Metric: Primary measurable outcome for `Regression Testing Loop`
...
Minimum frequency: Every merge and release
...
```yaml
loop_id: "loop-030-regression-testing-loop"
name: "Regression Testing Loop"
version: "1.0"
...
- Loop: Regression Testing Loop
- Outcome: Regression confidence result and release-blocking findings.
- Trigger: Code, configuration, infrastructure, model, data, or dependency change.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
