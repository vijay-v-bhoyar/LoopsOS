...
- Loop number: 29
- Loop name: End-to-End Testing Loop
- Category: 5. Testing, Validation and Experience Quality
- Skill ID: `loop-029-end-to-end-testing-loop`
- Version: `1.0`
...
- Minimum cadence: Nightly for critical paths and every release
...
Outcome to improve: End-to-end journey evidence and unresolved failure list.

Primary measurable outcome: End-to-end journey evidence and unresolved failure list.

Business value: Improves confidence, speed, safety, and accountability for End-to-End Testing Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that End-to-End Testing Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Testing, Validation and Experience Quality control point for End-to-End Testing Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `End-to-End Testing Loop`.
...
Release candidate or material change to a critical journey.
...
- Trigger condition: Release candidate or material change to a critical journey.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-029-end-to-end-testing-loop:<asset-or-scope>:<trigger-signature>`
...
Execute complete user and business workflows across systems, verify data movement and final outcomes, handle external dependencies, and clean up state.

## Output

End-to-end journey evidence and unresolved failure list.
...
- Loop record for `loop-029-end-to-end-testing-loop`
...
- Current state metric: To be measured for `End-to-End Testing Loop`
...
- Metric: Primary measurable outcome for `End-to-End Testing Loop`
...
Minimum frequency: Nightly for critical paths and every release
...
```yaml
loop_id: "loop-029-end-to-end-testing-loop"
name: "End-to-End Testing Loop"
version: "1.0"
...
- Loop: End-to-End Testing Loop
- Outcome: End-to-end journey evidence and unresolved failure list.
- Trigger: Release candidate or material change to a critical journey.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
