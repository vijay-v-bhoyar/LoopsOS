# User Acceptance Testing Loop

## Loop Identity

- Loop number: 32
- Loop name: User Acceptance Testing Loop
- Category: 5. Testing, Validation and Experience Quality
- Skill ID: `loop-032-user-acceptance-testing-loop`
- Version: `1.0`
...
- Minimum cadence: Every business release
...
Outcome to improve: Business sign-off, rejected release, or conditional acceptance.

Primary measurable outcome: Business sign-off, rejected release, or conditional acceptance.

Business value: Improves confidence, speed, safety, and accountability for User Acceptance Testing Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that User Acceptance Testing Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Testing, Validation and Experience Quality control point for User Acceptance Testing Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `User Acceptance Testing Loop`.
...
Business-ready release candidate.
...
- Trigger condition: Business-ready release candidate.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-032-user-acceptance-testing-loop:<asset-or-scope>:<trigger-signature>`
...
Prepare real business scenarios, authorized testers, expected outcomes, and representative data; record findings, resolve defects, and obtain explicit acceptance or waiver.

## Output

Business sign-off, rejected release, or conditional acceptance.
...
- Loop record for `loop-032-user-acceptance-testing-loop`
...
- Current state metric: To be measured for `User Acceptance Testing Loop`
...
- Metric: Primary measurable outcome for `User Acceptance Testing Loop`
...
Minimum frequency: Every business release
...
```yaml
loop_id: "loop-032-user-acceptance-testing-loop"
name: "User Acceptance Testing Loop"
version: "1.0"
...
- Loop: User Acceptance Testing Loop
- Outcome: Business sign-off, rejected release, or conditional acceptance.
- Trigger: Business-ready release candidate.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
