...
- Loop number: 34
- Loop name: Defect Management Loop
- Category: 5. Testing, Validation and Experience Quality
- Skill ID: `loop-034-defect-management-loop`
- Version: `1.0`
...
- Minimum cadence: Event-driven, triaged daily
...
Outcome to improve: Resolved or accepted defect and defect-trend data.

Primary measurable outcome: Resolved or accepted defect and defect-trend data.

Business value: Improves confidence, speed, safety, and accountability for Defect Management Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Defect Management Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Testing, Validation and Experience Quality control point for Defect Management Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Defect Management Loop`.
...
Defect reported by testing, monitoring, customer, security, or operations.
...
- Trigger condition: Defect reported by testing, monitoring, customer, security, or operations.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-034-defect-management-loop:<asset-or-scope>:<trigger-signature>`
...
Record and reproduce the issue, classify impact and priority, assign ownership, determine cause, fix, retest, run regression, and close with evidence.

## Output

Resolved or accepted defect and defect-trend data.
...
- Loop record for `loop-034-defect-management-loop`
...
- Current state metric: To be measured for `Defect Management Loop`
...
- Metric: Primary measurable outcome for `Defect Management Loop`
...
Minimum frequency: Event-driven, triaged daily
...
```yaml
loop_id: "loop-034-defect-management-loop"
name: "Defect Management Loop"
version: "1.0"
...
- Loop: Defect Management Loop
- Outcome: Resolved or accepted defect and defect-trend data.
- Trigger: Defect reported by testing, monitoring, customer, security, or operations.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
