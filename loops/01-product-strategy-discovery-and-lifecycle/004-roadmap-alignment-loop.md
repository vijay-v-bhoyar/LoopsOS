...
- Loop number: 4
- Loop name: Roadmap Alignment Loop
- Category: 1. Product Strategy, Discovery and Lifecycle
- Skill ID: `loop-004-roadmap-alignment-loop`
- Version: `1.0`
...
- Minimum cadence: Monthly or after major change
...
Outcome to improve: Prioritized roadmap, updated assumptions, dependency decisions, and release direction.

Primary measurable outcome: Prioritized roadmap, updated assumptions, dependency decisions, and release direction.

Business value: Improves confidence, speed, safety, and accountability for Roadmap Alignment Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Roadmap Alignment Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Product Strategy, Discovery and Lifecycle control point for Roadmap Alignment Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Roadmap Alignment Loop`.
...
Strategy, customer priority, capacity, dependency, regulation, or technology changes.
...
- Trigger condition: Strategy, customer priority, capacity, dependency, regulation, or technology changes.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-004-roadmap-alignment-loop:<asset-or-scope>:<trigger-signature>`
...
Rebalance initiatives based on value, risk, capacity, dependencies, architectural constraints, and sequencing.

## Output

Prioritized roadmap, updated assumptions, dependency decisions, and release direction.
...
- Loop record for `loop-004-roadmap-alignment-loop`
...
- Current state metric: To be measured for `Roadmap Alignment Loop`
...
- Metric: Primary measurable outcome for `Roadmap Alignment Loop`
...
Minimum frequency: Monthly or after major change
...
```yaml
loop_id: "loop-004-roadmap-alignment-loop"
name: "Roadmap Alignment Loop"
version: "1.0"
...
- Loop: Roadmap Alignment Loop
- Outcome: Prioritized roadmap, updated assumptions, dependency decisions, and release direction.
- Trigger: Strategy, customer priority, capacity, dependency, regulation, or technology changes.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
