...
- Loop number: 3
- Loop name: Business Value Validation Loop
- Category: 1. Product Strategy, Discovery and Lifecycle
- Skill ID: `loop-003-business-value-validation-loop`
- Version: `1.0`
...
Outcome to improve: Value scorecard and a scale, continue, change, pause, or stop recommendation.

Primary measurable outcome: Value scorecard and a scale, continue, change, pause, or stop recommendation.

Business value: Improves confidence, speed, safety, and accountability for Business Value Validation Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Business Value Validation Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Product Strategy, Discovery and Lifecycle control point for Business Value Validation Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Business Value Validation Loop`.
...
A scheduled value review or material variance in product performance.
...
- Trigger condition: A scheduled value review or material variance in product performance.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-003-business-value-validation-loop:<asset-or-scope>:<trigger-signature>`
...
Compare expected benefits with actual revenue, savings, quality, adoption, risk reduction, and operating cost. Check whether results are attributable to the product.

## Output

Value scorecard and a scale, continue, change, pause, or stop recommendation.
...
- Loop record for `loop-003-business-value-validation-loop`
...
- Current state metric: To be measured for `Business Value Validation Loop`
...
- Metric: Primary measurable outcome for `Business Value Validation Loop`
...
```yaml
loop_id: "loop-003-business-value-validation-loop"
name: "Business Value Validation Loop"
version: "1.0"
...
- Loop: Business Value Validation Loop
- Outcome: Value scorecard and a scale, continue, change, pause, or stop recommendation.
- Trigger: A scheduled value review or material variance in product performance.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
