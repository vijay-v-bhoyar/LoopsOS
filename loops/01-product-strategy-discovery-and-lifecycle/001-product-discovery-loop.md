...
- Loop number: 1
- Loop name: Product Discovery Loop
- Category: 1. Product Strategy, Discovery and Lifecycle
- Skill ID: `loop-001-product-discovery-loop`
- Version: `1.0`
...
- Minimum cadence: Continuous, with weekly review
...
Outcome to improve: Validated problem statement, supporting evidence, rejected assumptions, and candidate backlog items.

Primary measurable outcome: Validated problem statement, supporting evidence, rejected assumptions, and candidate backlog items.

Business value: Improves confidence, speed, safety, and accountability for Product Discovery Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Product Discovery Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Product Strategy, Discovery and Lifecycle control point for Product Discovery Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Product Discovery Loop`.
...
New customer evidence, support patterns, market changes, or proposed opportunities.
...
- Trigger condition: New customer evidence, support patterns, market changes, or proposed opportunities.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-001-product-discovery-loop:<asset-or-scope>:<trigger-signature>`
...
Collect evidence, define the user problem, identify expected outcomes, test assumptions through research or prototypes, and rank opportunities.

## Output

Validated problem statement, supporting evidence, rejected assumptions, and candidate backlog items.
...
- Loop record for `loop-001-product-discovery-loop`
...
- Current state metric: To be measured for `Product Discovery Loop`
...
- Metric: Primary measurable outcome for `Product Discovery Loop`
...
Minimum frequency: Continuous, with weekly review
...
- Loop: Product Discovery Loop
- Outcome: Validated problem statement, supporting evidence, rejected assumptions, and candidate backlog items.
- Trigger: New customer evidence, support patterns, market changes, or proposed opportunities.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
