...
- Loop number: 2
- Loop name: AI Use-Case Validation Loop
- Category: 1. Product Strategy, Discovery and Lifecycle
- Skill ID: `loop-002-ai-use-case-validation-loop`
- Version: `1.0`
...
- Minimum cadence: At use-case intake and before funding
...
Outcome to improve: Go, revise, or no-go decision with an AI use-case contract and success measures.

Primary measurable outcome: Go, revise, or no-go decision with an AI use-case contract and success measures.

Business value: Improves confidence, speed, safety, and accountability for AI Use-Case Validation Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that AI Use-Case Validation Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Product Strategy, Discovery and Lifecycle control point for AI Use-Case Validation Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `AI Use-Case Validation Loop`.
...
A proposal to use AI, GenAI, or agents.
...
- Trigger condition: A proposal to use AI, GenAI, or agents.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-002-ai-use-case-validation-loop:<asset-or-scope>:<trigger-signature>`
...
Compare AI with deterministic alternatives, assess data availability, evaluation feasibility, cost, risk, explainability, human oversight, and operational support. Prototype where necessary.

## Output

Go, revise, or no-go decision with an AI use-case contract and success measures.
...
- Loop record for `loop-002-ai-use-case-validation-loop`
...
- Current state metric: To be measured for `AI Use-Case Validation Loop`
...
- Metric: Primary measurable outcome for `AI Use-Case Validation Loop`
...
Minimum frequency: At use-case intake and before funding
...
```yaml
loop_id: "loop-002-ai-use-case-validation-loop"
name: "AI Use-Case Validation Loop"
version: "1.0"
...
- Loop: AI Use-Case Validation Loop
- Outcome: Go, revise, or no-go decision with an AI use-case contract and success measures.
- Trigger: A proposal to use AI, GenAI, or agents.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
