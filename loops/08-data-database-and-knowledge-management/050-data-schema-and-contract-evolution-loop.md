...
- Loop number: 50
- Loop name: Data Schema and Contract Evolution Loop
- Category: 8. Data, Database and Knowledge Management
- Skill ID: `loop-050-data-schema-and-contract-evolution-loop`
- Version: `1.0`
...
- Minimum cadence: Every schema change
...
Outcome to improve: Approved schema version, migration plan, and consumer compatibility evidence.

Primary measurable outcome: Approved schema version, migration plan, and consumer compatibility evidence.

Business value: Improves confidence, speed, safety, and accountability for Data Schema and Contract Evolution Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Data Schema and Contract Evolution Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Data, Database and Knowledge Management control point for Data Schema and Contract Evolution Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Data Schema and Contract Evolution Loop`.
...
Schema, event, file, table, or data-interface change.
...
- Trigger condition: Schema, event, file, table, or data-interface change.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-050-data-schema-and-contract-evolution-loop:<asset-or-scope>:<trigger-signature>`
...
Version the contract, identify producers and consumers, test compatibility, plan migration and backfill, manage dual-read or dual-write periods, and define rollback.

## Output

Approved schema version, migration plan, and consumer compatibility evidence.
...
- Loop record for `loop-050-data-schema-and-contract-evolution-loop`
...
- Current state metric: To be measured for `Data Schema and Contract Evolution Loop`
...
- Metric: Primary measurable outcome for `Data Schema and Contract Evolution Loop`
...
Minimum frequency: Every schema change
...
```yaml
loop_id: "loop-050-data-schema-and-contract-evolution-loop"
name: "Data Schema and Contract Evolution Loop"
version: "1.0"
...
- Loop: Data Schema and Contract Evolution Loop
- Outcome: Approved schema version, migration plan, and consumer compatibility evidence.
- Trigger: Schema, event, file, table, or data-interface change.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
