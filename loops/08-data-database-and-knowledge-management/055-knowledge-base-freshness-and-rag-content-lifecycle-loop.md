...
- Loop number: 55
- Loop name: Knowledge Base Freshness and RAG Content Lifecycle Loop
- Category: 8. Data, Database and Knowledge Management
- Skill ID: `loop-055-knowledge-base-freshness-and-rag-content-lifecycle-loop`
- Version: `1.0`
...
- Minimum cadence: Continuous or daily
...
Outcome to improve: Current knowledge index, freshness status, and content-lineage evidence.

Primary measurable outcome: Current knowledge index, freshness status, and content-lineage evidence.

Business value: Improves confidence, speed, safety, and accountability for Knowledge Base Freshness and RAG Content Lifecycle Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Knowledge Base Freshness and RAG Content Lifecycle Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Data, Database and Knowledge Management control point for Knowledge Base Freshness and RAG Content Lifecycle Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Knowledge Base Freshness and RAG Content Lifecycle Loop`.
...
Source creation, modification, expiry, revocation, or retrieval-quality issue.
...
- Trigger condition: Source creation, modification, expiry, revocation, or retrieval-quality issue.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-055-knowledge-base-freshness-and-rag-content-lifecycle-loop:<asset-or-scope>:<trigger-signature>`
...
Validate authority and access, ingest, chunk, index, refresh, expire, remove, and reindex content; confirm that deleted or restricted material is no longer retrievable.

## Output

Current knowledge index, freshness status, and content-lineage evidence.
...
- Loop record for `loop-055-knowledge-base-freshness-and-rag-content-lifecycle-loop`
...
- Current state metric: To be measured for `Knowledge Base Freshness and RAG Content Lifecycle Loop`
...
- Metric: Primary measurable outcome for `Knowledge Base Freshness and RAG Content Lifecycle Loop`
...
Minimum frequency: Continuous or daily
...
```yaml
loop_id: "loop-055-knowledge-base-freshness-and-rag-content-lifecycle-loop"
name: "Knowledge Base Freshness and RAG Content Lifecycle Loop"
version: "1.0"
...
- Loop: Knowledge Base Freshness and RAG Content Lifecycle Loop
- Outcome: Current knowledge index, freshness status, and content-lineage evidence.
- Trigger: Source creation, modification, expiry, revocation, or retrieval-quality issue.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
