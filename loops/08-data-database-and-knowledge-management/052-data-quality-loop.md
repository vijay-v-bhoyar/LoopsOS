...
- Loop number: 52
- Loop name: Data Quality Loop
- Category: 8. Data, Database and Knowledge Management
- Skill ID: `loop-052-data-quality-loop`
- Version: `1.0`
...
Outcome to improve: Data-quality score, resolved issue, and preventive rule.

Primary measurable outcome: Data-quality score, resolved issue, and preventive rule.

Business value: Improves confidence, speed, safety, and accountability for Data Quality Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Data Quality Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Data, Database and Knowledge Management control point for Data Quality Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Data Quality Loop`.
...
Data arrival, failed rule, anomaly, consumer complaint, or scheduled profiling.
...
- Trigger condition: Data arrival, failed rule, anomaly, consumer complaint, or scheduled profiling.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-052-data-quality-loop:<asset-or-scope>:<trigger-signature>`
...
Measure completeness, accuracy, validity, consistency, uniqueness, and timeliness; locate the source; correct data or pipeline logic; and reprocess affected records.

## Output

Data-quality score, resolved issue, and preventive rule.
...
- Loop record for `loop-052-data-quality-loop`
...
- Current state metric: To be measured for `Data Quality Loop`
...
- Metric: Primary measurable outcome for `Data Quality Loop`
...
```yaml
loop_id: "loop-052-data-quality-loop"
name: "Data Quality Loop"
version: "1.0"
...
- Loop: Data Quality Loop
- Outcome: Data-quality score, resolved issue, and preventive rule.
- Trigger: Data arrival, failed rule, anomaly, consumer complaint, or scheduled profiling.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
