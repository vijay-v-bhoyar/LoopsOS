...
- Loop number: 51
- Loop name: AI Data Preparation Loop
- Category: 8. Data, Database and Knowledge Management
- Skill ID: `loop-051-ai-data-preparation-loop`
- Version: `1.0`
...
- Minimum cadence: Every AI dataset change
...
Outcome to improve: Approved dataset, data documentation, quality results, and lineage.

Primary measurable outcome: Approved dataset, data documentation, quality results, and lineage.

Business value: Improves confidence, speed, safety, and accountability for AI Data Preparation Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that AI Data Preparation Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Data, Database and Knowledge Management control point for AI Data Preparation Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `AI Data Preparation Loop`.
...
New or changed data for training, tuning, evaluation, retrieval, or prompt examples.
...
- Trigger condition: New or changed data for training, tuning, evaluation, retrieval, or prompt examples.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-051-ai-data-preparation-loop:<asset-or-scope>:<trigger-signature>`
...
Validate source and usage rights, clean, normalize, deduplicate, label, de-identify, assess coverage and bias, split datasets, and version the result.

## Output

Approved dataset, data documentation, quality results, and lineage.
...
- Loop record for `loop-051-ai-data-preparation-loop`
...
- Current state metric: To be measured for `AI Data Preparation Loop`
...
- Metric: Primary measurable outcome for `AI Data Preparation Loop`
...
Minimum frequency: Every AI dataset change
...
```yaml
loop_id: "loop-051-ai-data-preparation-loop"
name: "AI Data Preparation Loop"
version: "1.0"
...
- Loop: AI Data Preparation Loop
- Outcome: Approved dataset, data documentation, quality results, and lineage.
- Trigger: New or changed data for training, tuning, evaluation, retrieval, or prompt examples.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
