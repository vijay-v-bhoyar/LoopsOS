...
- Loop number: 49
- Loop name: Data Governance Loop
- Category: 8. Data, Database and Knowledge Management
- Skill ID: `loop-049-data-governance-loop`
- Version: `1.0`
...
- Minimum cadence: Continuous, reviewed monthly or quarterly
...
Outcome to improve: Governed data asset with accountable ownership and enforceable policies.

Primary measurable outcome: Governed data asset with accountable ownership and enforceable policies.

Business value: Improves confidence, speed, safety, and accountability for Data Governance Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Data Governance Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Data, Database and Knowledge Management control point for Data Governance Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Data Governance Loop`.
...
New dataset, changed use, new system, ownership gap, or governance review.
...
- Trigger condition: New dataset, changed use, new system, ownership gap, or governance review.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-049-data-governance-loop:<asset-or-scope>:<trigger-signature>`
...
Catalog and classify data, assign owner and steward, define permitted use, quality expectations, lineage, access, retention, residency, and disposal rules.

## Output

Governed data asset with accountable ownership and enforceable policies.
...
- Loop record for `loop-049-data-governance-loop`
...
- Current state metric: To be measured for `Data Governance Loop`
...
- Metric: Primary measurable outcome for `Data Governance Loop`
...
Minimum frequency: Continuous, reviewed monthly or quarterly
...
```yaml
loop_id: "loop-049-data-governance-loop"
name: "Data Governance Loop"
version: "1.0"
...
- Loop: Data Governance Loop
- Outcome: Governed data asset with accountable ownership and enforceable policies.
- Trigger: New dataset, changed use, new system, ownership gap, or governance review.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
