...
- Loop number: 57
- Loop name: Prompt Engineering Loop
- Category: 9. AI and Generative AI Lifecycle and Quality
- Skill ID: `loop-057-prompt-engineering-loop`
- Version: `1.0`
...
- Minimum cadence: Every prompt change
...
Outcome to improve: Approved prompt version and evaluation results.

Primary measurable outcome: Approved prompt version and evaluation results.

Business value: Improves confidence, speed, safety, and accountability for Prompt Engineering Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Prompt Engineering Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: AI and Generative AI Lifecycle and Quality control point for Prompt Engineering Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Prompt Engineering Loop`.
...
New AI task, prompt defect, model change, or evaluation regression.
...
- Trigger condition: New AI task, prompt defect, model change, or evaluation regression.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-057-prompt-engineering-loop:<asset-or-scope>:<trigger-signature>`
...
Define the task contract, instructions, variables, examples, constraints, source use, output schema, and refusal behavior; evaluate, version, deploy, and preserve rollback.

## Output

Approved prompt version and evaluation results.
...
- Loop record for `loop-057-prompt-engineering-loop`
...
- Current state metric: To be measured for `Prompt Engineering Loop`
...
- Metric: Primary measurable outcome for `Prompt Engineering Loop`
...
Minimum frequency: Every prompt change
...
```yaml
loop_id: "loop-057-prompt-engineering-loop"
...
- Loop: Prompt Engineering Loop
- Outcome: Approved prompt version and evaluation results.
- Trigger: New AI task, prompt defect, model change, or evaluation regression.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
