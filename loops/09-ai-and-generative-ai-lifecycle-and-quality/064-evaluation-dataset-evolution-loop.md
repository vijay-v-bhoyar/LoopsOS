...
- Loop number: 64
- Loop name: Evaluation Dataset Evolution Loop
- Category: 9. AI and Generative AI Lifecycle and Quality
- Skill ID: `loop-064-evaluation-dataset-evolution-loop`
- Version: `1.0`
...
- Minimum cadence: Weekly or monthly, and after incidents
...
Outcome to improve: Versioned evaluation set with documented coverage.

Primary measurable outcome: Versioned evaluation set with documented coverage.

Business value: Improves confidence, speed, safety, and accountability for Evaluation Dataset Evolution Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Evaluation Dataset Evolution Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: AI and Generative AI Lifecycle and Quality control point for Evaluation Dataset Evolution Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Evaluation Dataset Evolution Loop`.
...
Production failure, new capability, emerging threat, model change, or weak evaluation coverage.
...
- Trigger condition: Production failure, new capability, emerging threat, model change, or weak evaluation coverage.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-064-evaluation-dataset-evolution-loop:<asset-or-scope>:<trigger-signature>`
...
Add difficult, representative, adversarial, ambiguous, and edge cases; check labels, duplication, leakage, contamination, segment balance, and version history.

## Output

Versioned evaluation set with documented coverage.
...
- Loop record for `loop-064-evaluation-dataset-evolution-loop`
...
- Current state metric: To be measured for `Evaluation Dataset Evolution Loop`
...
- Metric: Primary measurable outcome for `Evaluation Dataset Evolution Loop`
...
Minimum frequency: Weekly or monthly, and after incidents
...
```yaml
loop_id: "loop-064-evaluation-dataset-evolution-loop"
name: "Evaluation Dataset Evolution Loop"
version: "1.0"
...
- Loop: Evaluation Dataset Evolution Loop
- Outcome: Versioned evaluation set with documented coverage.
- Trigger: Production failure, new capability, emerging threat, model change, or weak evaluation coverage.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
