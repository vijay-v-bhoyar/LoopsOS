...
- Loop number: 61
- Loop name: Hallucination Reduction Loop
- Category: 9. AI and Generative AI Lifecycle and Quality
- Skill ID: `loop-061-hallucination-reduction-loop`
- Version: `1.0`
...
- Minimum cadence: Continuous, reviewed daily or weekly
...
Outcome to improve: Corrected behavior and reduced unsupported-answer rate.

Primary measurable outcome: Corrected behavior and reduced unsupported-answer rate.

Business value: Improves confidence, speed, safety, and accountability for Hallucination Reduction Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Hallucination Reduction Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: AI and Generative AI Lifecycle and Quality control point for Hallucination Reduction Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Hallucination Reduction Loop`.
...
Unsupported answer, incorrect citation, fabricated detail, or low-grounding score.
...
- Trigger condition: Unsupported answer, incorrect citation, fabricated detail, or low-grounding score.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-061-hallucination-reduction-loop:<asset-or-scope>:<trigger-signature>`
...
Capture and classify the failure, inspect context and retrieval, improve prompt, source selection, verification, confidence, or abstention controls, and add the case to regression testing.

## Output

Corrected behavior and reduced unsupported-answer rate.
...
- Loop record for `loop-061-hallucination-reduction-loop`
...
- Current state metric: To be measured for `Hallucination Reduction Loop`
...
- Metric: Primary measurable outcome for `Hallucination Reduction Loop`
...
Minimum frequency: Continuous, reviewed daily or weekly
...
name: "Hallucination Reduction Loop"
version: "1.0"
...
- Loop: Hallucination Reduction Loop
- Outcome: Corrected behavior and reduced unsupported-answer rate.
- Trigger: Unsupported answer, incorrect citation, fabricated detail, or low-grounding score.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
