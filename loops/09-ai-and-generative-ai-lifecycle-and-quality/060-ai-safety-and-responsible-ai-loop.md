...
- Loop number: 60
- Loop name: AI Safety and Responsible AI Loop
- Category: 9. AI and Generative AI Lifecycle and Quality
- Skill ID: `loop-060-ai-safety-and-responsible-ai-loop`
- Version: `1.0`
...
- Minimum cadence: Every AI release, with quarterly deep review
...
Outcome to improve: Risk classification, required safeguards, residual-risk acceptance, and approval status.

Primary measurable outcome: Risk classification, required safeguards, residual-risk acceptance, and approval status.

Business value: Improves confidence, speed, safety, and accountability for AI Safety and Responsible AI Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that AI Safety and Responsible AI Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: AI and Generative AI Lifecycle and Quality control point for AI Safety and Responsible AI Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `AI Safety and Responsible AI Loop`.
...
New AI use case, model, data, prompt, user group, deployment, or material behavior change.
...
- Trigger condition: New AI use case, model, data, prompt, user group, deployment, or material behavior change.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-060-ai-safety-and-responsible-ai-loop:<asset-or-scope>:<trigger-signature>`
...
Assess harmful outputs, bias, fairness, privacy, transparency, human impact, explainability needs, misuse, vulnerable users, and control effectiveness.

## Output

Risk classification, required safeguards, residual-risk acceptance, and approval status.
...
- Loop record for `loop-060-ai-safety-and-responsible-ai-loop`
...
- Current state metric: To be measured for `AI Safety and Responsible AI Loop`
...
- Metric: Primary measurable outcome for `AI Safety and Responsible AI Loop`
...
Minimum frequency: Every AI release, with quarterly deep review
...
```yaml
loop_id: "loop-060-ai-safety-and-responsible-ai-loop"
name: "AI Safety and Responsible AI Loop"
version: "1.0"
...
- Loop: AI Safety and Responsible AI Loop
- Outcome: Risk classification, required safeguards, residual-risk acceptance, and approval status.
- Trigger: New AI use case, model, data, prompt, user group, deployment, or material behavior change.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
