...
- Loop number: 59
- Loop name: RAG Quality Loop
- Category: 9. AI and Generative AI Lifecycle and Quality
- Skill ID: `loop-059-rag-quality-loop`
- Version: `1.0`
...
- Minimum cadence: Every RAG change, with scheduled regression
...
Outcome to improve: RAG scorecard, failure categories, and tuning actions.

Primary measurable outcome: RAG scorecard, failure categories, and tuning actions.

Business value: Improves confidence, speed, safety, and accountability for RAG Quality Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that RAG Quality Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: AI and Generative AI Lifecycle and Quality control point for RAG Quality Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `RAG Quality Loop`.
...
Retrieval, embedding, chunking, reranking, source, index, or model change.
...
- Trigger condition: Retrieval, embedding, chunking, reranking, source, index, or model change.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-059-rag-quality-loop:<asset-or-scope>:<trigger-signature>`
...
Evaluate ingestion, recall, precision, ranking, source authority, citation accuracy, groundedness, answer relevance, conflict handling, and abstention behavior.

## Output

RAG scorecard, failure categories, and tuning actions.
...
- Loop record for `loop-059-rag-quality-loop`
...
- Current state metric: To be measured for `RAG Quality Loop`
...
- Metric: Primary measurable outcome for `RAG Quality Loop`
...
Minimum frequency: Every RAG change, with scheduled regression
...
```yaml
loop_id: "loop-059-rag-quality-loop"
...
- Loop: RAG Quality Loop
- Outcome: RAG scorecard, failure categories, and tuning actions.
- Trigger: Retrieval, embedding, chunking, reranking, source, index, or model change.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
