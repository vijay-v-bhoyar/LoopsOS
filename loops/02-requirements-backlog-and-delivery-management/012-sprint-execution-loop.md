...
- Loop number: 12
- Loop name: Sprint Execution Loop
- Category: 2. Requirements, Backlog and Delivery Management
- Skill ID: `loop-012-sprint-execution-loop`
- Version: `1.0`
...
- Minimum cadence: Every sprint, tracked daily
...
Outcome to improve: Completed sprint objective, accepted work, delivery metrics, and carried-over decisions.

Primary measurable outcome: Completed sprint objective, accepted work, delivery metrics, and carried-over decisions.

Business value: Improves confidence, speed, safety, and accountability for Sprint Execution Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Sprint Execution Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Requirements, Backlog and Delivery Management control point for Sprint Execution Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Sprint Execution Loop`.
...
Start of an iteration or committed delivery period.
...
- Trigger condition: Start of an iteration or committed delivery period.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-012-sprint-execution-loop:<asset-or-scope>:<trigger-signature>`
...
Confirm goal and capacity, commit work, track progress, remove blockers, validate completed work, demonstrate outcomes, and close unfinished items correctly.

## Output

Completed sprint objective, accepted work, delivery metrics, and carried-over decisions.
...
- Loop record for `loop-012-sprint-execution-loop`
...
- Current state metric: To be measured for `Sprint Execution Loop`
...
- Metric: Primary measurable outcome for `Sprint Execution Loop`
...
Minimum frequency: Every sprint, tracked daily
...
```yaml
loop_id: "loop-012-sprint-execution-loop"
...
- Loop: Sprint Execution Loop
- Outcome: Completed sprint objective, accepted work, delivery metrics, and carried-over decisions.
- Trigger: Start of an iteration or committed delivery period.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
