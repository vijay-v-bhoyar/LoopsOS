...
- Loop number: 11
- Loop name: Risk Management Loop
- Category: 2. Requirements, Backlog and Delivery Management
- Skill ID: `loop-011-risk-management-loop`
- Version: `1.0`
...
Outcome to improve: Updated risk register and explicit accept, mitigate, transfer, avoid, or escalate decision.

Primary measurable outcome: Updated risk register and explicit accept, mitigate, transfer, avoid, or escalate decision.

Business value: Improves confidence, speed, safety, and accountability for Risk Management Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Risk Management Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Requirements, Backlog and Delivery Management control point for Risk Management Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Risk Management Loop`.
...
New work, material change, incident, delay, audit finding, or emerging uncertainty.
...
- Trigger condition: New work, material change, incident, delay, audit finding, or emerging uncertainty.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-011-risk-management-loop:<asset-or-scope>:<trigger-signature>`
...
Identify and score probability and impact, define triggers, assign ownership, plan mitigation and contingency, and reassess residual risk.

## Output

Updated risk register and explicit accept, mitigate, transfer, avoid, or escalate decision.
...
- Loop record for `loop-011-risk-management-loop`
...
- Current state metric: To be measured for `Risk Management Loop`
...
- Metric: Primary measurable outcome for `Risk Management Loop`
...
```yaml
loop_id: "loop-011-risk-management-loop"
name: "Risk Management Loop"
version: "1.0"
...
- Loop: Risk Management Loop
- Outcome: Updated risk register and explicit accept, mitigate, transfer, avoid, or escalate decision.
- Trigger: New work, material change, incident, delay, audit finding, or emerging uncertainty.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
