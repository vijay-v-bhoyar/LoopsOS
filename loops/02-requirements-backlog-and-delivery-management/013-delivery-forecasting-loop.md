...
- Loop number: 13
- Loop name: Delivery Forecasting Loop
- Category: 2. Requirements, Backlog and Delivery Management
- Skill ID: `loop-013-delivery-forecasting-loop`
- Version: `1.0`
...
Outcome to improve: Updated completion range, confidence level, assumptions, and corrective actions.

Primary measurable outcome: Updated completion range, confidence level, assumptions, and corrective actions.

Business value: Improves confidence, speed, safety, and accountability for Delivery Forecasting Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Delivery Forecasting Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Requirements, Backlog and Delivery Management control point for Delivery Forecasting Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Delivery Forecasting Loop`.
...
New scope, throughput changes, dependency changes, or schedule variance.
...
- Trigger condition: New scope, throughput changes, dependency changes, or schedule variance.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-013-delivery-forecasting-loop:<asset-or-scope>:<trigger-signature>`
...
Use remaining scope, historical throughput, capacity, uncertainty, and dependencies to produce scenario-based forecasts.

## Output

Updated completion range, confidence level, assumptions, and corrective actions.
...
- Loop record for `loop-013-delivery-forecasting-loop`
...
- Current state metric: To be measured for `Delivery Forecasting Loop`
...
- Metric: Primary measurable outcome for `Delivery Forecasting Loop`
...
```yaml
loop_id: "loop-013-delivery-forecasting-loop"
name: "Delivery Forecasting Loop"
version: "1.0"
...
- Loop: Delivery Forecasting Loop
- Outcome: Updated completion range, confidence level, assumptions, and corrective actions.
- Trigger: New scope, throughput changes, dependency changes, or schedule variance.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
