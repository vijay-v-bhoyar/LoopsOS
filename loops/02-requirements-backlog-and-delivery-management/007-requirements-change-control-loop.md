...
- Loop number: 7
- Loop name: Requirements Change Control Loop
- Category: 2. Requirements, Backlog and Delivery Management
- Skill ID: `loop-007-requirements-change-control-loop`
- Version: `1.0`
...
- Minimum cadence: Every material change
...
Outcome to improve: Approved, deferred, or rejected change with updated baselines and impact evidence.

Primary measurable outcome: Approved, deferred, or rejected change with updated baselines and impact evidence.

Business value: Improves confidence, speed, safety, and accountability for Requirements Change Control Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Requirements Change Control Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Requirements, Backlog and Delivery Management control point for Requirements Change Control Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Requirements Change Control Loop`.
...
Requested change to approved scope or behavior.
...
- Trigger condition: Requested change to approved scope or behavior.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-007-requirements-change-control-loop:<asset-or-scope>:<trigger-signature>`
...
Assess impact on value, scope, cost, schedule, architecture, data, security, testing, operations, and dependencies; route the change to the correct authority.

## Output

Approved, deferred, or rejected change with updated baselines and impact evidence.
...
- Loop record for `loop-007-requirements-change-control-loop`
...
- Current state metric: To be measured for `Requirements Change Control Loop`
...
- Metric: Primary measurable outcome for `Requirements Change Control Loop`
...
Minimum frequency: Every material change
...
```yaml
loop_id: "loop-007-requirements-change-control-loop"
name: "Requirements Change Control Loop"
version: "1.0"
...
- Loop: Requirements Change Control Loop
- Outcome: Approved, deferred, or rejected change with updated baselines and impact evidence.
- Trigger: Requested change to approved scope or behavior.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
