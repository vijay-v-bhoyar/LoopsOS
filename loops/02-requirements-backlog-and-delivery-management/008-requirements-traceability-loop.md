...
- Loop number: 8
- Loop name: Requirements Traceability Loop
- Category: 2. Requirements, Backlog and Delivery Management
- Skill ID: `loop-008-requirements-traceability-loop`
- Version: `1.0`
...
- Minimum cadence: Every change, with release gate
...
Outcome to improve: Traceability graph or matrix, coverage gaps, and release evidence.

Primary measurable outcome: Traceability graph or matrix, coverage gaps, and release evidence.

Business value: Improves confidence, speed, safety, and accountability for Requirements Traceability Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Requirements Traceability Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Requirements, Backlog and Delivery Management control point for Requirements Traceability Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Requirements Traceability Loop`.
...
Requirement, design, code, test, or release changes.
...
- Trigger condition: Requirement, design, code, test, or release changes.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-008-requirements-traceability-loop:<asset-or-scope>:<trigger-signature>`
...
Link business objective to requirement, design, implementation, test case, release, and production evidence; identify broken or missing links.

## Output

Traceability graph or matrix, coverage gaps, and release evidence.
...
- Loop record for `loop-008-requirements-traceability-loop`
...
- Current state metric: To be measured for `Requirements Traceability Loop`
...
- Metric: Primary measurable outcome for `Requirements Traceability Loop`
...
Minimum frequency: Every change, with release gate
...
```yaml
loop_id: "loop-008-requirements-traceability-loop"
name: "Requirements Traceability Loop"
version: "1.0"
...
- Loop: Requirements Traceability Loop
- Outcome: Traceability graph or matrix, coverage gaps, and release evidence.
- Trigger: Requirement, design, code, test, or release changes.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
