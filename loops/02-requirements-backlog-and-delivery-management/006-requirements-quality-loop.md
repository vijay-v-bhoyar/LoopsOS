...
- Loop number: 6
- Loop name: Requirements Quality Loop
- Category: 2. Requirements, Backlog and Delivery Management
- Skill ID: `loop-006-requirements-quality-loop`
- Version: `1.0`
...
- Minimum cadence: Every requirement or story
...
Outcome to improve: Ready, revise, or reject decision with identified gaps.

Primary measurable outcome: Ready, revise, or reject decision with identified gaps.

Business value: Improves confidence, speed, safety, and accountability for Requirements Quality Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Requirements Quality Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Requirements, Backlog and Delivery Management control point for Requirements Quality Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Requirements Quality Loop`.
...
Creation or modification of a requirement, feature, story, or acceptance criterion.
...
- Trigger condition: Creation or modification of a requirement, feature, story, or acceptance criterion.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-006-requirements-quality-loop:<asset-or-scope>:<trigger-signature>`
...
Check clarity, completeness, testability, feasibility, assumptions, non-functional needs, data needs, security, dependencies, and measurable acceptance criteria.

## Output

Ready, revise, or reject decision with identified gaps.
...
- Loop record for `loop-006-requirements-quality-loop`
...
- Current state metric: To be measured for `Requirements Quality Loop`
...
- Metric: Primary measurable outcome for `Requirements Quality Loop`
...
Minimum frequency: Every requirement or story
...
```yaml
loop_id: "loop-006-requirements-quality-loop"
name: "Requirements Quality Loop"
version: "1.0"
...
- Loop: Requirements Quality Loop
- Outcome: Ready, revise, or reject decision with identified gaps.
- Trigger: Creation or modification of a requirement, feature, story, or acceptance criterion.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
