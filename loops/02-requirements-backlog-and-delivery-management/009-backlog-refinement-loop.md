...
- Loop number: 9
- Loop name: Backlog Refinement Loop
- Category: 2. Requirements, Backlog and Delivery Management
- Skill ID: `loop-009-backlog-refinement-loop`
- Version: `1.0`
...
- Minimum cadence: Weekly or every sprint
...
Outcome to improve: Prioritized, estimated, and delivery-ready backlog.

Primary measurable outcome: Prioritized, estimated, and delivery-ready backlog.

Business value: Improves confidence, speed, safety, and accountability for Backlog Refinement Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Backlog Refinement Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Requirements, Backlog and Delivery Management control point for Backlog Refinement Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Backlog Refinement Loop`.
...
New work, changed priorities, or upcoming iteration planning.
...
- Trigger condition: New work, changed priorities, or upcoming iteration planning.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-009-backlog-refinement-loop:<asset-or-scope>:<trigger-signature>`
...
Remove duplicates, split oversized work, clarify outcomes, add acceptance criteria, identify dependencies, estimate effort, and establish readiness.

## Output

Prioritized, estimated, and delivery-ready backlog.
...
- Loop record for `loop-009-backlog-refinement-loop`
...
- Current state metric: To be measured for `Backlog Refinement Loop`
...
- Metric: Primary measurable outcome for `Backlog Refinement Loop`
...
Minimum frequency: Weekly or every sprint
...
```yaml
loop_id: "loop-009-backlog-refinement-loop"
name: "Backlog Refinement Loop"
version: "1.0"
...
- Loop: Backlog Refinement Loop
- Outcome: Prioritized, estimated, and delivery-ready backlog.
- Trigger: New work, changed priorities, or upcoming iteration planning.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
