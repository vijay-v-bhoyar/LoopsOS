...
- Loop number: 14
- Loop name: Retrospective Improvement Loop
- Category: 2. Requirements, Backlog and Delivery Management
- Skill ID: `loop-014-retrospective-improvement-loop`
- Version: `1.0`
...
- Minimum cadence: Every sprint or release
...
Outcome to improve: Owned improvement actions with due dates and effectiveness measures.

Primary measurable outcome: Owned improvement actions with due dates and effectiveness measures.

Business value: Improves confidence, speed, safety, and accountability for Retrospective Improvement Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Retrospective Improvement Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Requirements, Backlog and Delivery Management control point for Retrospective Improvement Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Retrospective Improvement Loop`.
...
End of sprint, release, incident, or major delivery stage.
...
- Trigger condition: End of sprint, release, incident, or major delivery stage.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-014-retrospective-improvement-loop:<asset-or-scope>:<trigger-signature>`
...
Review evidence, identify effective and ineffective practices, find root causes, select a limited number of improvements, assign owners, and measure whether prior actions worked.

## Output

Owned improvement actions with due dates and effectiveness measures.
...
- Loop record for `loop-014-retrospective-improvement-loop`
...
- Current state metric: To be measured for `Retrospective Improvement Loop`
...
- Metric: Primary measurable outcome for `Retrospective Improvement Loop`
...
Minimum frequency: Every sprint or release
...
```yaml
loop_id: "loop-014-retrospective-improvement-loop"
name: "Retrospective Improvement Loop"
version: "1.0"
...
- Loop: Retrospective Improvement Loop
- Outcome: Owned improvement actions with due dates and effectiveness measures.
- Trigger: End of sprint, release, incident, or major delivery stage.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
