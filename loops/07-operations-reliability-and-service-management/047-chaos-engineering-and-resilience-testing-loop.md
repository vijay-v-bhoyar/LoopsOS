...
- Loop number: 47
- Loop name: Chaos Engineering and Resilience Testing Loop
- Category: 7. Operations, Reliability and Service Management
- Skill ID: `loop-047-chaos-engineering-and-resilience-testing-loop`
- Version: `1.0`
...
- Minimum cadence: Monthly or quarterly
...
Outcome to improve: Proven resilience behavior, failure evidence, and hardening backlog.

Primary measurable outcome: Proven resilience behavior, failure evidence, and hardening backlog.

Business value: Improves confidence, speed, safety, and accountability for Chaos Engineering and Resilience Testing Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Chaos Engineering and Resilience Testing Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Operations, Reliability and Service Management control point for Chaos Engineering and Resilience Testing Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Chaos Engineering and Resilience Testing Loop`.
...
New resilience hypothesis, architecture change, or scheduled exercise.
...
- Trigger condition: New resilience hypothesis, architecture change, or scheduled exercise.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-047-chaos-engineering-and-resilience-testing-loop:<asset-or-scope>:<trigger-signature>`
...
Define safe failure scenarios and blast radius, inject controlled faults, observe detection and recovery, stop safely, remediate weaknesses, and repeat.

## Output

Proven resilience behavior, failure evidence, and hardening backlog.
...
- Loop record for `loop-047-chaos-engineering-and-resilience-testing-loop`
...
- Current state metric: To be measured for `Chaos Engineering and Resilience Testing Loop`
...
- Metric: Primary measurable outcome for `Chaos Engineering and Resilience Testing Loop`
...
Minimum frequency: Monthly or quarterly
...
```yaml
loop_id: "loop-047-chaos-engineering-and-resilience-testing-loop"
name: "Chaos Engineering and Resilience Testing Loop"
version: "1.0"
...
- Loop: Chaos Engineering and Resilience Testing Loop
- Outcome: Proven resilience behavior, failure evidence, and hardening backlog.
- Trigger: New resilience hypothesis, architecture change, or scheduled exercise.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
