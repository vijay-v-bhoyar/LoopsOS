...
- Loop number: 42
- Loop name: Reliability, SLO and Error-Budget Management Loop
- Category: 7. Operations, Reliability and Service Management
- Skill ID: `loop-042-reliability-slo-and-error-budget-management-loop`
- Version: `1.0`
...
Outcome to improve: Reliability scorecard, error-budget decision, and resilience actions.

Primary measurable outcome: Reliability scorecard, error-budget decision, and resilience actions.

Business value: Improves confidence, speed, safety, and accountability for Reliability, SLO and Error-Budget Management Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Reliability, SLO and Error-Budget Management Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Operations, Reliability and Service Management control point for Reliability, SLO and Error-Budget Management Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Reliability, SLO and Error-Budget Management Loop`.
...
SLO definition, service degradation, error-budget consumption, or scheduled reliability review.
...
- Trigger condition: SLO definition, service degradation, error-budget consumption, or scheduled reliability review.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-042-reliability-slo-and-error-budget-management-loop:<asset-or-scope>:<trigger-signature>`
...
Define or measure SLIs and SLOs, analyze failure modes, track error budget, prioritize reliability work, and restrict risky changes when thresholds are exceeded.

## Output

Reliability scorecard, error-budget decision, and resilience actions.
...
- Loop record for `loop-042-reliability-slo-and-error-budget-management-loop`
...
- Current state metric: To be measured for `Reliability, SLO and Error-Budget Management Loop`
...
- Metric: Primary measurable outcome for `Reliability, SLO and Error-Budget Management Loop`
...
```yaml
loop_id: "loop-042-reliability-slo-and-error-budget-management-loop"
name: "Reliability, SLO and Error-Budget Management Loop"
version: "1.0"
...
- Loop: Reliability, SLO and Error-Budget Management Loop
- Outcome: Reliability scorecard, error-budget decision, and resilience actions.
- Trigger: SLO definition, service degradation, error-budget consumption, or scheduled reliability review.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
