...
- Loop number: 43
- Loop name: Incident Management Loop
- Category: 7. Operations, Reliability and Service Management
- Skill ID: `loop-043-incident-management-loop`
- Version: `1.0`
...
Outcome to improve: Restored service, incident timeline, impact statement, and corrective actions.

Primary measurable outcome: Restored service, incident timeline, impact statement, and corrective actions.

Business value: Improves confidence, speed, safety, and accountability for Incident Management Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Incident Management Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Operations, Reliability and Service Management control point for Incident Management Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Incident Management Loop`.
...
Actual or suspected service disruption, degradation, security event, or customer-impacting failure.
...
- Trigger condition: Actual or suspected service disruption, degradation, security event, or customer-impacting failure.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-043-incident-management-loop:<asset-or-scope>:<trigger-signature>`
...
Detect, classify severity, assign command, contain, restore service, communicate, preserve evidence, and create follow-up actions.

## Output

Restored service, incident timeline, impact statement, and corrective actions.
...
- Loop record for `loop-043-incident-management-loop`
...
- Current state metric: To be measured for `Incident Management Loop`
...
- Metric: Primary measurable outcome for `Incident Management Loop`
...
```yaml
loop_id: "loop-043-incident-management-loop"
name: "Incident Management Loop"
version: "1.0"
...
- Loop: Incident Management Loop
- Outcome: Restored service, incident timeline, impact statement, and corrective actions.
- Trigger: Actual or suspected service disruption, degradation, security event, or customer-impacting failure.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
