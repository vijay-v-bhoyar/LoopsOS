...
- Loop number: 45
- Loop name: Problem Management Loop
- Category: 7. Operations, Reliability and Service Management
- Skill ID: `loop-045-problem-management-loop`
- Version: `1.0`
...
- Minimum cadence: Weekly and after major incidents
...
Outcome to improve: Root-cause record, permanent corrective action, and recurrence evidence.

Primary measurable outcome: Root-cause record, permanent corrective action, and recurrence evidence.

Business value: Improves confidence, speed, safety, and accountability for Problem Management Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Problem Management Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Operations, Reliability and Service Management control point for Problem Management Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Problem Management Loop`.
...
Repeated incidents, recurring defects, unexplained instability, or material post-incident finding.
...
- Trigger condition: Repeated incidents, recurring defects, unexplained instability, or material post-incident finding.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-045-problem-management-loop:<asset-or-scope>:<trigger-signature>`
...
Group related events, analyze systemic cause, document known error and workaround, implement permanent correction, and monitor recurrence.

## Output

Root-cause record, permanent corrective action, and recurrence evidence.
...
- Loop record for `loop-045-problem-management-loop`
...
- Current state metric: To be measured for `Problem Management Loop`
...
- Metric: Primary measurable outcome for `Problem Management Loop`
...
Minimum frequency: Weekly and after major incidents
...
```yaml
loop_id: "loop-045-problem-management-loop"
name: "Problem Management Loop"
version: "1.0"
...
- Loop: Problem Management Loop
- Outcome: Root-cause record, permanent corrective action, and recurrence evidence.
- Trigger: Repeated incidents, recurring defects, unexplained instability, or material post-incident finding.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
