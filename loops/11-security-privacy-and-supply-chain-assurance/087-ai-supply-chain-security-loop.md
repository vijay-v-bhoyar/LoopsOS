...
- Loop number: 87
- Loop name: AI Supply-Chain Security Loop
- Category: 11. Security, Privacy and Supply-Chain Assurance
- Skill ID: `loop-087-ai-supply-chain-security-loop`
- Version: `1.0`
...
- Minimum cadence: Every component change, reviewed quarterly
...
Outcome to improve: AI component record and supplier-risk decision.

Primary measurable outcome: AI component record and supplier-risk decision.

Business value: Improves confidence, speed, safety, and accountability for AI Supply-Chain Security Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that AI Supply-Chain Security Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Security, Privacy and Supply-Chain Assurance control point for AI Supply-Chain Security Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `AI Supply-Chain Security Loop`.
...
Onboarding or changing a model, dataset, embedding, agent framework, plugin, MCP server, tool, container, or external AI API.
...
- Trigger condition: Onboarding or changing a model, dataset, embedding, agent framework, plugin, MCP server, tool, container, or external AI API.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-087-ai-supply-chain-security-loop:<asset-or-scope>:<trigger-signature>`
...
Inventory the component, assess provenance, ownership, license, security, privacy, availability, provider change risk, and required access; approve, restrict, monitor, or replace it.

## Output

AI component record and supplier-risk decision.
...
- Loop record for `loop-087-ai-supply-chain-security-loop`
...
- Current state metric: To be measured for `AI Supply-Chain Security Loop`
...
- Metric: Primary measurable outcome for `AI Supply-Chain Security Loop`
...
Minimum frequency: Every component change, reviewed quarterly
...
```yaml
loop_id: "loop-087-ai-supply-chain-security-loop"
name: "AI Supply-Chain Security Loop"
version: "1.0"
...
- Loop: AI Supply-Chain Security Loop
- Outcome: AI component record and supplier-risk decision.
- Trigger: Onboarding or changing a model, dataset, embedding, agent framework, plugin, MCP server, tool, container, or external AI API.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
