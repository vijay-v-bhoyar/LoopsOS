...
- Loop number: 79
- Loop name: Agent Guardrail Loop
- Category: 11. Security, Privacy and Supply-Chain Assurance
- Skill ID: `loop-079-agent-guardrail-loop`
- Version: `1.0`
...
- Minimum cadence: Every consequential agent action
...
Outcome to improve: Guardrail decision and audit record.

Primary measurable outcome: Guardrail decision and audit record.

Business value: Improves confidence, speed, safety, and accountability for Agent Guardrail Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Agent Guardrail Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Security, Privacy and Supply-Chain Assurance control point for Agent Guardrail Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Agent Guardrail Loop`.
...
Agent proposes an action, response, tool call, or state change.
...
- Trigger condition: Agent proposes an action, response, tool call, or state change.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-079-agent-guardrail-loop:<asset-or-scope>:<trigger-signature>`
...
Evaluate the proposal against user intent, policy, authorization, allowlists, risk tier, reversibility, transaction limits, and approval requirements; allow, modify, block, or escalate.

## Output

Guardrail decision and audit record.
...
- Loop record for `loop-079-agent-guardrail-loop`
...
- Current state metric: To be measured for `Agent Guardrail Loop`
...
- Metric: Primary measurable outcome for `Agent Guardrail Loop`
...
Minimum frequency: Every consequential agent action
...
- Loop: Agent Guardrail Loop
- Outcome: Guardrail decision and audit record.
- Trigger: Agent proposes an action, response, tool call, or state change.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
