...
- Loop number: 89
- Loop name: Audit Logging and Forensic Readiness Loop
- Category: 11. Security, Privacy and Supply-Chain Assurance
- Skill ID: `loop-089-audit-logging-and-forensic-readiness-loop`
- Version: `1.0`
...
- Minimum cadence: Continuous, tested quarterly
...
Outcome to improve: Searchable evidence trail and forensic-readiness result.

Primary measurable outcome: Searchable evidence trail and forensic-readiness result.

Business value: Improves confidence, speed, safety, and accountability for Audit Logging and Forensic Readiness Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Audit Logging and Forensic Readiness Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Security, Privacy and Supply-Chain Assurance control point for Audit Logging and Forensic Readiness Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Audit Logging and Forensic Readiness Loop`.
...
User, service, model, agent, tool, data, configuration, security, or administrative action.
...
- Trigger condition: User, service, model, agent, tool, data, configuration, security, or administrative action.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-089-audit-logging-and-forensic-readiness-loop:<asset-or-scope>:<trigger-signature>`
...
Produce tamper-resistant, time-synchronized, correlated logs with appropriate retention and access controls; periodically prove that an event can be reconstructed.

## Output

Searchable evidence trail and forensic-readiness result.
...
- Loop record for `loop-089-audit-logging-and-forensic-readiness-loop`
...
- Current state metric: To be measured for `Audit Logging and Forensic Readiness Loop`
...
- Metric: Primary measurable outcome for `Audit Logging and Forensic Readiness Loop`
...
Minimum frequency: Continuous, tested quarterly
...
```yaml
loop_id: "loop-089-audit-logging-and-forensic-readiness-loop"
name: "Audit Logging and Forensic Readiness Loop"
version: "1.0"
...
- Loop: Audit Logging and Forensic Readiness Loop
- Outcome: Searchable evidence trail and forensic-readiness result.
- Trigger: User, service, model, agent, tool, data, configuration, security, or administrative action.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
