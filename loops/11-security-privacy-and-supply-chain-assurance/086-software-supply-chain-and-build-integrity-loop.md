...
- Loop number: 86
- Loop name: Software Supply-Chain and Build Integrity Loop
- Category: 11. Security, Privacy and Supply-Chain Assurance
- Skill ID: `loop-086-software-supply-chain-and-build-integrity-loop`
- Version: `1.0`
...
- Minimum cadence: Every build and release
...
Outcome to improve: Trusted or blocked artifact with provenance evidence.

Primary measurable outcome: Trusted or blocked artifact with provenance evidence.

Business value: Improves confidence, speed, safety, and accountability for Software Supply-Chain and Build Integrity Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Software Supply-Chain and Build Integrity Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Security, Privacy and Supply-Chain Assurance control point for Software Supply-Chain and Build Integrity Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Software Supply-Chain and Build Integrity Loop`.
...
Source change, dependency update, build, artifact publication, or release.
...
- Trigger condition: Source change, dependency update, build, artifact publication, or release.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-086-software-supply-chain-and-build-integrity-loop:<asset-or-scope>:<trigger-signature>`
...
Verify source provenance, signed changes, isolated build process, dependency integrity, software bill of materials, artifact signatures, attestations, and reproducibility.

## Output

Trusted or blocked artifact with provenance evidence.
...
- Loop record for `loop-086-software-supply-chain-and-build-integrity-loop`
...
- Current state metric: To be measured for `Software Supply-Chain and Build Integrity Loop`
...
- Metric: Primary measurable outcome for `Software Supply-Chain and Build Integrity Loop`
...
Minimum frequency: Every build and release
...
```yaml
loop_id: "loop-086-software-supply-chain-and-build-integrity-loop"
name: "Software Supply-Chain and Build Integrity Loop"
version: "1.0"
...
- Loop: Software Supply-Chain and Build Integrity Loop
- Outcome: Trusted or blocked artifact with provenance evidence.
- Trigger: Source change, dependency update, build, artifact publication, or release.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
