...
- Loop number: 90
- Loop name: AI Red-Team Evolution Loop
- Category: 11. Security, Privacy and Supply-Chain Assurance
- Skill ID: `loop-090-ai-red-team-evolution-loop`
- Version: `1.0`
...
- Minimum cadence: Monthly or quarterly, and after incidents
...
Outcome to improve: Expanding adversarial suite and control-effectiveness trend.

Primary measurable outcome: Expanding adversarial suite and control-effectiveness trend.

Business value: Improves confidence, speed, safety, and accountability for AI Red-Team Evolution Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that AI Red-Team Evolution Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Security, Privacy and Supply-Chain Assurance control point for AI Red-Team Evolution Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `AI Red-Team Evolution Loop`.
...
New attack method, provider disclosure, internal failure, incident, or model capability.
...
- Trigger condition: New attack method, provider disclosure, internal failure, incident, or model capability.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-090-ai-red-team-evolution-loop:<asset-or-scope>:<trigger-signature>`
...
Convert threats and failures into adversarial cases, run them across versions, record bypasses, improve defenses, and preserve failures as security regression tests.

## Output

Expanding adversarial suite and control-effectiveness trend.
...
- Loop record for `loop-090-ai-red-team-evolution-loop`
...
- Current state metric: To be measured for `AI Red-Team Evolution Loop`
...
- Metric: Primary measurable outcome for `AI Red-Team Evolution Loop`
...
Minimum frequency: Monthly or quarterly, and after incidents
...
```yaml
loop_id: "loop-090-ai-red-team-evolution-loop"
name: "AI Red-Team Evolution Loop"
version: "1.0"
...
- Loop: AI Red-Team Evolution Loop
- Outcome: Expanding adversarial suite and control-effectiveness trend.
- Trigger: New attack method, provider disclosure, internal failure, incident, or model capability.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
