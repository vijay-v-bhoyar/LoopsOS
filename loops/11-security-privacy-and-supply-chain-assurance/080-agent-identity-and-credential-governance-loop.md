...
- Loop number: 80
- Loop name: Agent Identity and Credential Governance Loop
- Category: 11. Security, Privacy and Supply-Chain Assurance
- Skill ID: `loop-080-agent-identity-and-credential-governance-loop`
- Version: `1.0`
...
- Minimum cadence: Every agent session or access change
...
Outcome to improve: Governed agent identity and credential record.

Primary measurable outcome: Governed agent identity and credential record.

Business value: Improves confidence, speed, safety, and accountability for Agent Identity and Credential Governance Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Agent Identity and Credential Governance Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Security, Privacy and Supply-Chain Assurance control point for Agent Identity and Credential Governance Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Agent Identity and Credential Governance Loop`.
...
Agent creation, session start, tool access, credential change, or termination.
...
- Trigger condition: Agent creation, session start, tool access, credential change, or termination.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-080-agent-identity-and-credential-governance-loop:<asset-or-scope>:<trigger-signature>`
...
Assign a distinct non-human identity, issue scoped and short-lived credentials, store secrets securely, rotate and revoke access, and preserve action attribution.

## Output

Governed agent identity and credential record.
...
- Loop record for `loop-080-agent-identity-and-credential-governance-loop`
...
- Current state metric: To be measured for `Agent Identity and Credential Governance Loop`
...
- Metric: Primary measurable outcome for `Agent Identity and Credential Governance Loop`
...
Minimum frequency: Every agent session or access change
...
```yaml
loop_id: "loop-080-agent-identity-and-credential-governance-loop"
name: "Agent Identity and Credential Governance Loop"
version: "1.0"
...
- Loop: Agent Identity and Credential Governance Loop
- Outcome: Governed agent identity and credential record.
- Trigger: Agent creation, session start, tool access, credential change, or termination.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
