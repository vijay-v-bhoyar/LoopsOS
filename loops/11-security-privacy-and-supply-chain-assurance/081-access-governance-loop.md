...
- Loop number: 81
- Loop name: Access Governance Loop
- Category: 11. Security, Privacy and Supply-Chain Assurance
- Skill ID: `loop-081-access-governance-loop`
- Version: `1.0`
...
- Minimum cadence: Continuous, with quarterly recertification
...
Outcome to improve: Approved access state and certification evidence.

Primary measurable outcome: Approved access state and certification evidence.

Business value: Improves confidence, speed, safety, and accountability for Access Governance Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Access Governance Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Security, Privacy and Supply-Chain Assurance control point for Access Governance Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Access Governance Loop`.
...
User, service, agent, role, employment, responsibility, or system change.
...
- Trigger condition: User, service, agent, role, employment, responsibility, or system change.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-081-access-governance-loop:<asset-or-scope>:<trigger-signature>`
...
Apply least privilege, role or attribute policies, privileged-access controls, joiner-mover-leaver processing, conflict checks, periodic recertification, and access removal.

## Output

Approved access state and certification evidence.
...
- Loop record for `loop-081-access-governance-loop`
...
- Current state metric: To be measured for `Access Governance Loop`
...
- Metric: Primary measurable outcome for `Access Governance Loop`
...
Minimum frequency: Continuous, with quarterly recertification
...
```yaml
loop_id: "loop-081-access-governance-loop"
name: "Access Governance Loop"
version: "1.0"
...
- Loop: Access Governance Loop
- Outcome: Approved access state and certification evidence.
- Trigger: User, service, agent, role, employment, responsibility, or system change.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
