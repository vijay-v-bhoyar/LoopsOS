...
- Loop number: 77
- Loop name: Secure SDLC Loop
- Category: 11. Security, Privacy and Supply-Chain Assurance
- Skill ID: `loop-077-secure-sdlc-loop`
- Version: `1.0`
...
Outcome to improve: Security evidence, unresolved-risk decision, and release status.

Primary measurable outcome: Security evidence, unresolved-risk decision, and release status.

Business value: Improves confidence, speed, safety, and accountability for Secure SDLC Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Secure SDLC Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Security, Privacy and Supply-Chain Assurance control point for Secure SDLC Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Secure SDLC Loop`.
...
New product, feature, design, code change, or release.
...
- Trigger condition: New product, feature, design, code change, or release.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-077-secure-sdlc-loop:<asset-or-scope>:<trigger-signature>`
...
Define security requirements, perform threat modeling, design review, static and dynamic testing, secrets and infrastructure scanning, remediation, retesting, and release-risk assessment.

## Output

Security evidence, unresolved-risk decision, and release status.
...
- Loop record for `loop-077-secure-sdlc-loop`
...
- Current state metric: To be measured for `Secure SDLC Loop`
...
- Metric: Primary measurable outcome for `Secure SDLC Loop`
...
```yaml
loop_id: "loop-077-secure-sdlc-loop"
name: "Secure SDLC Loop"
version: "1.0"
...
- Loop: Secure SDLC Loop
- Outcome: Security evidence, unresolved-risk decision, and release status.
- Trigger: New product, feature, design, code change, or release.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
