...
- Loop number: 104
- Loop name: Compliance Evidence Loop
- Category: 13. Enterprise Governance, Adoption and Workforce
- Skill ID: `loop-104-compliance-evidence-loop`
- Version: `1.0`
...
- Minimum cadence: Continuous collection, monthly or quarterly review
...
Outcome to improve: Current control status and audit-ready evidence set.

Primary measurable outcome: Current control status and audit-ready evidence set.

Business value: Improves confidence, speed, safety, and accountability for Compliance Evidence Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Compliance Evidence Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Enterprise Governance, Adoption and Workforce control point for Compliance Evidence Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Compliance Evidence Loop`.
...
Control execution, audit requirement, regulatory obligation, or evidence-expiry threshold.
...
- Trigger condition: Control execution, audit requirement, regulatory obligation, or evidence-expiry threshold.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-104-compliance-evidence-loop:<asset-or-scope>:<trigger-signature>`
...
Map controls to systems and owners, collect authoritative evidence, verify completeness and freshness, identify gaps, initiate remediation, and package evidence for review.

## Output

Current control status and audit-ready evidence set.
...
- Loop record for `loop-104-compliance-evidence-loop`
...
- Current state metric: To be measured for `Compliance Evidence Loop`
...
- Metric: Primary measurable outcome for `Compliance Evidence Loop`
...
Minimum frequency: Continuous collection, monthly or quarterly review
...
```yaml
loop_id: "loop-104-compliance-evidence-loop"
...
- Loop: Compliance Evidence Loop
- Outcome: Current control status and audit-ready evidence set.
- Trigger: Control execution, audit requirement, regulatory obligation, or evidence-expiry threshold.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
