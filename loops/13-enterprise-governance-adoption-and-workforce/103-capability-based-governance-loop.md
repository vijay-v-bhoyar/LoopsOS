...
- Loop number: 103
- Loop name: Capability-Based Governance Loop
- Category: 13. Enterprise Governance, Adoption and Workforce
- Skill ID: `loop-103-capability-based-governance-loop`
- Version: `1.0`
...
- Minimum cadence: Every onboarding or upgrade, reviewed quarterly
...
Outcome to improve: Governance tier and enforceable control profile.

Primary measurable outcome: Governance tier and enforceable control profile.

Business value: Improves confidence, speed, safety, and accountability for Capability-Based Governance Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Capability-Based Governance Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Enterprise Governance, Adoption and Workforce control point for Capability-Based Governance Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Capability-Based Governance Loop`.
...
Model or agent onboarding, upgrade, new use, or scheduled governance review.
...
- Trigger condition: Model or agent onboarding, upgrade, new use, or scheduled governance review.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-103-capability-based-governance-loop:<asset-or-scope>:<trigger-signature>`
...
Classify actual capabilities and potential impact rather than relying on vendor labels; map the tier to mandatory evaluations, security, monitoring, human approval, containment, and audit controls.

## Output

Governance tier and enforceable control profile.
...
- Loop record for `loop-103-capability-based-governance-loop`
...
- Current state metric: To be measured for `Capability-Based Governance Loop`
...
- Metric: Primary measurable outcome for `Capability-Based Governance Loop`
...
Minimum frequency: Every onboarding or upgrade, reviewed quarterly
...
```yaml
loop_id: "loop-103-capability-based-governance-loop"
name: "Capability-Based Governance Loop"
version: "1.0"
...
- Loop: Capability-Based Governance Loop
- Outcome: Governance tier and enforceable control profile.
- Trigger: Model or agent onboarding, upgrade, new use, or scheduled governance review.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
