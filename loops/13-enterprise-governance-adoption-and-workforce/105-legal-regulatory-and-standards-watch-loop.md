...
- Loop number: 105
- Loop name: Legal, Regulatory and Standards Watch Loop
- Category: 13. Enterprise Governance, Adoption and Workforce
- Skill ID: `loop-105-legal-regulatory-and-standards-watch-loop`
- Version: `1.0`
...
Outcome to improve: Obligation register and required product, process, or policy changes.

Primary measurable outcome: Obligation register and required product, process, or policy changes.

Business value: Improves confidence, speed, safety, and accountability for Legal, Regulatory and Standards Watch Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Legal, Regulatory and Standards Watch Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Enterprise Governance, Adoption and Workforce control point for Legal, Regulatory and Standards Watch Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Legal, Regulatory and Standards Watch Loop`.
...
New law, regulation, standard, enforcement action, contractual obligation, or jurisdictional expansion.
...
- Trigger condition: New law, regulation, standard, enforcement action, contractual obligation, or jurisdictional expansion.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-105-legal-regulatory-and-standards-watch-loop:<asset-or-scope>:<trigger-signature>`
...
Determine applicability, assess product and operating impact, map required changes to controls and owners, track implementation, and retain decision evidence.

## Output

Obligation register and required product, process, or policy changes.
...
- Loop record for `loop-105-legal-regulatory-and-standards-watch-loop`
...
- Current state metric: To be measured for `Legal, Regulatory and Standards Watch Loop`
...
- Metric: Primary measurable outcome for `Legal, Regulatory and Standards Watch Loop`
...
```yaml
loop_id: "loop-105-legal-regulatory-and-standards-watch-loop"
name: "Legal, Regulatory and Standards Watch Loop"
version: "1.0"
...
- Loop: Legal, Regulatory and Standards Watch Loop
- Outcome: Obligation register and required product, process, or policy changes.
- Trigger: New law, regulation, standard, enforcement action, contractual obligation, or jurisdictional expansion.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
