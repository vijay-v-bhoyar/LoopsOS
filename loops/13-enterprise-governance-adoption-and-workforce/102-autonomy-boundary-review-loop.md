...
- Loop number: 102
- Loop name: Autonomy Boundary Review Loop
- Category: 13. Enterprise Governance, Adoption and Workforce
- Skill ID: `loop-102-autonomy-boundary-review-loop`
- Version: `1.0`
...
- Minimum cadence: Every authority change, reviewed quarterly
...
Outcome to improve: Authority map, least-privilege policy, and prohibited-action list.

Primary measurable outcome: Authority map, least-privilege policy, and prohibited-action list.

Business value: Improves confidence, speed, safety, and accountability for Autonomy Boundary Review Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Autonomy Boundary Review Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Enterprise Governance, Adoption and Workforce control point for Autonomy Boundary Review Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Autonomy Boundary Review Loop`.
...
Agent permission, tool, system, model, workflow, or data-access change.
...
- Trigger condition: Agent permission, tool, system, model, workflow, or data-access change.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-102-autonomy-boundary-review-loop:<asset-or-scope>:<trigger-signature>`
...
Inventory what the agent can read, write, delete, deploy, communicate, purchase, approve, spend, create, or delegate; simulate misuse and remove unnecessary authority.

## Output

Authority map, least-privilege policy, and prohibited-action list.
...
- Loop record for `loop-102-autonomy-boundary-review-loop`
...
- Current state metric: To be measured for `Autonomy Boundary Review Loop`
...
- Metric: Primary measurable outcome for `Autonomy Boundary Review Loop`
...
Minimum frequency: Every authority change, reviewed quarterly
...
```yaml
loop_id: "loop-102-autonomy-boundary-review-loop"
name: "Autonomy Boundary Review Loop"
version: "1.0"
...
- Loop: Autonomy Boundary Review Loop
- Outcome: Authority map, least-privilege policy, and prohibited-action list.
- Trigger: Agent permission, tool, system, model, workflow, or data-access change.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
