...
- Loop number: 106
- Loop name: Vendor and Third-Party Risk and SLA Loop
- Category: 13. Enterprise Governance, Adoption and Workforce
- Skill ID: `loop-106-vendor-and-third-party-risk-and-sla-loop`
- Version: `1.0`
...
- Minimum cadence: Onboarding and monthly or quarterly review
...
Outcome to improve: Approved, restricted, remediated, or exited vendor decision.

Primary measurable outcome: Approved, restricted, remediated, or exited vendor decision.

Business value: Improves confidence, speed, safety, and accountability for Vendor and Third-Party Risk and SLA Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Vendor and Third-Party Risk and SLA Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Enterprise Governance, Adoption and Workforce control point for Vendor and Third-Party Risk and SLA Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Vendor and Third-Party Risk and SLA Loop`.
...
Vendor onboarding, contract renewal, performance breach, incident, material service change, or scheduled review.
...
- Trigger condition: Vendor onboarding, contract renewal, performance breach, incident, material service change, or scheduled review.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-106-vendor-and-third-party-risk-and-sla-loop:<asset-or-scope>:<trigger-signature>`
...
Assess security, privacy, resilience, compliance, concentration, subcontractors, data access, financial viability, service performance, exit capability, and SLA compliance.

## Output

Approved, restricted, remediated, or exited vendor decision.
...
- Loop record for `loop-106-vendor-and-third-party-risk-and-sla-loop`
...
- Current state metric: To be measured for `Vendor and Third-Party Risk and SLA Loop`
...
- Metric: Primary measurable outcome for `Vendor and Third-Party Risk and SLA Loop`
...
Minimum frequency: Onboarding and monthly or quarterly review
...
```yaml
loop_id: "loop-106-vendor-and-third-party-risk-and-sla-loop"
name: "Vendor and Third-Party Risk and SLA Loop"
version: "1.0"
...
- Loop: Vendor and Third-Party Risk and SLA Loop
- Outcome: Approved, restricted, remediated, or exited vendor decision.
- Trigger: Vendor onboarding, contract renewal, performance breach, incident, material service change, or scheduled review.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
