...
- Loop number: 101
- Loop name: Agent Autonomy Calibration Loop
- Category: 13. Enterprise Governance, Adoption and Workforce
- Skill ID: `loop-101-agent-autonomy-calibration-loop`
- Version: `1.0`
...
Outcome to improve: Approved autonomy level and conditions for expansion or reduction.

Primary measurable outcome: Approved autonomy level and conditions for expansion or reduction.

Business value: Improves confidence, speed, safety, and accountability for Agent Autonomy Calibration Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Agent Autonomy Calibration Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Enterprise Governance, Adoption and Workforce control point for Agent Autonomy Calibration Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Agent Autonomy Calibration Loop`.
...
New agent, material model change, performance trend, incident, or scheduled autonomy review.
...
- Trigger condition: New agent, material model change, performance trend, incident, or scheduled autonomy review.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-101-agent-autonomy-calibration-loop:<asset-or-scope>:<trigger-signature>`
...
Evaluate task risk, historical reliability, reversibility, detectability, supervision cost, and failure severity; assign the appropriate autonomy mode and monitor outcomes.

## Output

Approved autonomy level and conditions for expansion or reduction.
...
- Loop record for `loop-101-agent-autonomy-calibration-loop`
...
- Current state metric: To be measured for `Agent Autonomy Calibration Loop`
...
- Metric: Primary measurable outcome for `Agent Autonomy Calibration Loop`
...
```yaml
loop_id: "loop-101-agent-autonomy-calibration-loop"
name: "Agent Autonomy Calibration Loop"
version: "1.0"
...
- Loop: Agent Autonomy Calibration Loop
- Outcome: Approved autonomy level and conditions for expansion or reduction.
- Trigger: New agent, material model change, performance trend, incident, or scheduled autonomy review.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
