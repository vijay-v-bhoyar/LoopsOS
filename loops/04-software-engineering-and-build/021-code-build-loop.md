...
- Skill ID: `loop-021-code-build-loop`
- Version: `1.0`
...
- Minimum cadence: Every work item or commit
...
Outcome to improve: Working change, updated tests, build artifact, and implementation evidence.

Primary measurable outcome: Working change, updated tests, build artifact, and implementation evidence.

Business value: Improves confidence, speed, safety, and accountability for Code Build Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Code Build Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Software Engineering and Build control point for Code Build Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Code Build Loop`.
...
Approved engineering task or defect.
...
- Trigger condition: Approved engineering task or defect.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-021-code-build-loop:<asset-or-scope>:<trigger-signature>`
...
Inspect existing code, understand constraints, design the change, implement it, compile or package it, execute local checks, and prepare reviewable artifacts.

## Output

Working change, updated tests, build artifact, and implementation evidence.
...
- Loop record for `loop-021-code-build-loop`
...
- Current state metric: To be measured for `Code Build Loop`
...
- Metric: Primary measurable outcome for `Code Build Loop`
...
Minimum frequency: Every work item or commit
...
```yaml
loop_id: "loop-021-code-build-loop"
name: "Code Build Loop"
version: "1.0"
...
- Outcome: Working change, updated tests, build artifact, and implementation evidence.
- Trigger: Approved engineering task or defect.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
