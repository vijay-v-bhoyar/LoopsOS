...
- Loop number: 23
- Loop name: Pull Request Review Loop
- Category: 4. Software Engineering and Build
- Skill ID: `loop-023-pull-request-review-loop`
- Version: `1.0`
...
- Minimum cadence: Every pull request
...
Outcome to improve: Approved or rejected pull request with resolved comments and review evidence.

Primary measurable outcome: Approved or rejected pull request with resolved comments and review evidence.

Business value: Improves confidence, speed, safety, and accountability for Pull Request Review Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Pull Request Review Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Software Engineering and Build control point for Pull Request Review Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Pull Request Review Loop`.
...
- Trigger condition: Pull request ready for review.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-023-pull-request-review-loop:<asset-or-scope>:<trigger-signature>`
...
Independently inspect correctness, tests, design, security, performance, data impact, compatibility, and operational effects; require correction and re-review where needed.

## Output

Approved or rejected pull request with resolved comments and review evidence.
...
- Loop record for `loop-023-pull-request-review-loop`
...
- Current state metric: To be measured for `Pull Request Review Loop`
...
- Metric: Primary measurable outcome for `Pull Request Review Loop`
...
Minimum frequency: Every pull request
...
```yaml
loop_id: "loop-023-pull-request-review-loop"
...
- Loop: Pull Request Review Loop
- Outcome: Approved or rejected pull request with resolved comments and review evidence.
