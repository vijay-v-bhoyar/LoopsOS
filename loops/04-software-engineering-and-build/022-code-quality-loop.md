...
- Loop number: 22
- Loop name: Code Quality Loop
- Category: 4. Software Engineering and Build
- Skill ID: `loop-022-code-quality-loop`
- Version: `1.0`
...
Outcome to improve: Quality results, resolved findings, and maintainable code.

Primary measurable outcome: Quality results, resolved findings, and maintainable code.

Business value: Improves confidence, speed, safety, and accountability for Code Quality Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Code Quality Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Software Engineering and Build control point for Code Quality Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Code Quality Loop`.
...
- Trigger condition: Code creation or modification.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-022-code-quality-loop:<asset-or-scope>:<trigger-signature>`
...
Check standards, readability, complexity, duplication, maintainability, error handling, dead code, logging, and testability; refactor until thresholds pass.

## Output

Quality results, resolved findings, and maintainable code.
...
- Loop record for `loop-022-code-quality-loop`
...
- Current state metric: To be measured for `Code Quality Loop`
...
- Metric: Primary measurable outcome for `Code Quality Loop`
...
```yaml
loop_id: "loop-022-code-quality-loop"
...
- Loop: Code Quality Loop
- Outcome: Quality results, resolved findings, and maintainable code.
- Trigger: Code creation or modification.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
