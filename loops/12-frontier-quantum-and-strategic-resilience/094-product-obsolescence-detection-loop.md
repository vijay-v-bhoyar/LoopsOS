...
- Loop number: 94
- Loop name: Product Obsolescence Detection Loop
- Category: 12. Frontier, Quantum and Strategic Resilience
- Skill ID: `loop-094-product-obsolescence-detection-loop`
- Version: `1.0`
...
Outcome to improve: Obsolescence-risk score and defend, differentiate, pivot, partner, or retire decision.

Primary measurable outcome: Obsolescence-risk score and defend, differentiate, pivot, partner, or retire decision.

Business value: Improves confidence, speed, safety, and accountability for Product Obsolescence Detection Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Product Obsolescence Detection Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Frontier, Quantum and Strategic Resilience control point for Product Obsolescence Detection Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Product Obsolescence Detection Loop`.
...
Frontier capability, competitor, platform, pricing, or customer-expectation change.
...
- Trigger condition: Frontier capability, competitor, platform, pricing, or customer-expectation change.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-094-product-obsolescence-detection-loop:<asset-or-scope>:<trigger-signature>`
...
Test whether a general model or platform now performs the product’s core task, identify commoditized features, assess unique data, workflow, trust, integration, compliance, and distribution advantages, and reposition where needed.

## Output

Obsolescence-risk score and defend, differentiate, pivot, partner, or retire decision.
...
- Loop record for `loop-094-product-obsolescence-detection-loop`
...
- Current state metric: To be measured for `Product Obsolescence Detection Loop`
...
- Metric: Primary measurable outcome for `Product Obsolescence Detection Loop`
...
```yaml
loop_id: "loop-094-product-obsolescence-detection-loop"
name: "Product Obsolescence Detection Loop"
version: "1.0"
...
- Loop: Product Obsolescence Detection Loop
- Outcome: Obsolescence-risk score and defend, differentiate, pivot, partner, or retire decision.
- Trigger: Frontier capability, competitor, platform, pricing, or customer-expectation change.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
