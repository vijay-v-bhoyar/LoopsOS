...
- Loop number: 96
- Loop name: Post-Quantum Cryptography, Crypto-Agility and Long-Lived Data Protection Loop
- Category: 12. Frontier, Quantum and Strategic Resilience
- Skill ID: `loop-096-post-quantum-cryptography-crypto-agility-and-long-lived-data-protection-loop`
- Version: `1.0`
...
- Minimum cadence: Semiannual or annual
...
Outcome to improve: Cryptographic inventory, exposure register, crypto-agility score, and migration roadmap.

Primary measurable outcome: Cryptographic inventory, exposure register, crypto-agility score, and migration roadmap.

Business value: Improves confidence, speed, safety, and accountability for Post-Quantum Cryptography, Crypto-Agility and Long-Lived Data Protection Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Post-Quantum Cryptography, Crypto-Agility and Long-Lived Data Protection Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Frontier, Quantum and Strategic Resilience control point for Post-Quantum Cryptography, Crypto-Agility and Long-Lived Data Protection Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Post-Quantum Cryptography, Crypto-Agility and Long-Lived Data Protection Loop`.
...
Cryptographic change, standard update, vendor roadmap change, or scheduled quantum-risk review.
...
- Trigger condition: Cryptographic change, standard update, vendor roadmap change, or scheduled quantum-risk review.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-096-post-quantum-cryptography-crypto-agility-and-long-lived-data-protection-loop:<asset-or-scope>:<trigger-signature>`
...
Inventory cryptography, identify quantum-vulnerable algorithms and long-lived sensitive data, abstract algorithm dependencies, test replacement or hybrid methods, measure interoperability and performance, and prioritize migration.

## Output

Cryptographic inventory, exposure register, crypto-agility score, and migration roadmap.
...
- Loop record for `loop-096-post-quantum-cryptography-crypto-agility-and-long-lived-data-protection-loop`
...
- Current state metric: To be measured for `Post-Quantum Cryptography, Crypto-Agility and Long-Lived Data Protection Loop`
...
- Metric: Primary measurable outcome for `Post-Quantum Cryptography, Crypto-Agility and Long-Lived Data Protection Loop`
...
Minimum frequency: Semiannual or annual
...
```yaml
loop_id: "loop-096-post-quantum-cryptography-crypto-agility-and-long-lived-data-protection-loop"
name: "Post-Quantum Cryptography, Crypto-Agility and Long-Lived Data Protection Loop"
version: "1.0"
...
- Loop: Post-Quantum Cryptography, Crypto-Agility and Long-Lived Data Protection Loop
- Outcome: Cryptographic inventory, exposure register, crypto-agility score, and migration roadmap.
- Trigger: Cryptographic change, standard update, vendor roadmap change, or scheduled quantum-risk review.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
