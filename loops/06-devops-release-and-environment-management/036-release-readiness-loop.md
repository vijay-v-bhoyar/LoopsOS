...
- Loop number: 36
- Loop name: Release Readiness Loop
- Category: 6. DevOps, Release and Environment Management
- Skill ID: `loop-036-release-readiness-loop`
- Version: `1.0`
...
Outcome to improve: Go, conditional-go, or no-go decision with evidence.

Primary measurable outcome: Go, conditional-go, or no-go decision with evidence.

Business value: Improves confidence, speed, safety, and accountability for Release Readiness Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Release Readiness Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: DevOps, Release and Environment Management control point for Release Readiness Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Release Readiness Loop`.
...
Release candidate prepared for deployment.
...
- Trigger condition: Release candidate prepared for deployment.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-036-release-readiness-loop:<asset-or-scope>:<trigger-signature>`
...
Verify scope, traceability, tests, defects, security, compliance, data migration, operational support, monitoring, rollback, approvals, and known limitations.

## Output

Go, conditional-go, or no-go decision with evidence.
...
- Loop record for `loop-036-release-readiness-loop`
...
- Current state metric: To be measured for `Release Readiness Loop`
...
- Metric: Primary measurable outcome for `Release Readiness Loop`
...
Minimum frequency: Every release
...
- Outcome: Go, conditional-go, or no-go decision with evidence.
- Trigger: Release candidate prepared for deployment.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
