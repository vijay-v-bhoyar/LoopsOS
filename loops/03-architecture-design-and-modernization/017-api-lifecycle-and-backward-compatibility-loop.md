...
- Loop number: 17
- Loop name: API Lifecycle and Backward Compatibility Loop
- Category: 3. Architecture, Design and Modernization
- Skill ID: `loop-017-api-lifecycle-and-backward-compatibility-loop`
- Version: `1.0`
...
- Minimum cadence: Every API change
...
Outcome to improve: Approved API version, migration guidance, consumer notifications, and retirement timeline.

Primary measurable outcome: Approved API version, migration guidance, consumer notifications, and retirement timeline.

Business value: Improves confidence, speed, safety, and accountability for API Lifecycle and Backward Compatibility Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that API Lifecycle and Backward Compatibility Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Architecture, Design and Modernization control point for API Lifecycle and Backward Compatibility Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `API Lifecycle and Backward Compatibility Loop`.
...
New API, contract modification, version change, or planned deprecation.
...
- Trigger condition: New API, contract modification, version change, or planned deprecation.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-017-api-lifecycle-and-backward-compatibility-loop:<asset-or-scope>:<trigger-signature>`
...
Validate schemas, authentication, authorization, rate limits, errors, versioning, consumer impact, backward compatibility, documentation, and deprecation plan.

## Output

Approved API version, migration guidance, consumer notifications, and retirement timeline.
...
- Loop record for `loop-017-api-lifecycle-and-backward-compatibility-loop`
...
- Current state metric: To be measured for `API Lifecycle and Backward Compatibility Loop`
...
- Metric: Primary measurable outcome for `API Lifecycle and Backward Compatibility Loop`
...
Minimum frequency: Every API change
...
```yaml
loop_id: "loop-017-api-lifecycle-and-backward-compatibility-loop"
name: "API Lifecycle and Backward Compatibility Loop"
version: "1.0"
...
- Loop: API Lifecycle and Backward Compatibility Loop
- Outcome: Approved API version, migration guidance, consumer notifications, and retirement timeline.
- Trigger: New API, contract modification, version change, or planned deprecation.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
