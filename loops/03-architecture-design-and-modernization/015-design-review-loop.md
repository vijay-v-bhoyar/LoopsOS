...
- Loop number: 15
- Loop name: Design Review Loop
- Category: 3. Architecture, Design and Modernization
- Skill ID: `loop-015-design-review-loop`
- Version: `1.0`
...
- Minimum cadence: Every material design change
...
Outcome to improve: Approved, conditionally approved, or rejected design with required actions and decision record.

Primary measurable outcome: Approved, conditionally approved, or rejected design with required actions and decision record.

Business value: Improves confidence, speed, safety, and accountability for Design Review Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Design Review Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Architecture, Design and Modernization control point for Design Review Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Design Review Loop`.
...
New solution, major feature, integration, data flow, or significant design change.
...
- Trigger condition: New solution, major feature, integration, data flow, or significant design change.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-015-design-review-loop:<asset-or-scope>:<trigger-signature>`
...
Review functional design, non-functional requirements, interfaces, data movement, failure modes, security boundaries, operability, scalability, and standards.

## Output

Approved, conditionally approved, or rejected design with required actions and decision record.
...
- Loop record for `loop-015-design-review-loop`
...
- Current state metric: To be measured for `Design Review Loop`
...
- Metric: Primary measurable outcome for `Design Review Loop`
...
Minimum frequency: Every material design change
...
```yaml
loop_id: "loop-015-design-review-loop"
...
- Loop: Design Review Loop
- Outcome: Approved, conditionally approved, or rejected design with required actions and decision record.
- Trigger: New solution, major feature, integration, data flow, or significant design change.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
