...
- Loop number: 20
- Loop name: Application Modernization Loop
- Category: 3. Architecture, Design and Modernization
- Skill ID: `loop-020-application-modernization-loop`
- Version: `1.0`
...
Outcome to improve: Modernization roadmap, migration increments, and decommissioning evidence.

Primary measurable outcome: Modernization roadmap, migration increments, and decommissioning evidence.

Business value: Improves confidence, speed, safety, and accountability for Application Modernization Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Application Modernization Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Architecture, Design and Modernization control point for Application Modernization Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Application Modernization Loop`.
...
Unsupported technology, excessive operating cost, reliability limitation, scalability constraint, or strategic platform change.
...
- Trigger condition: Unsupported technology, excessive operating cost, reliability limitation, scalability constraint, or strategic platform change.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-020-application-modernization-loop:<asset-or-scope>:<trigger-signature>`
...
Inventory legacy components, assess support and risk, compare modernization options, plan migration, execute incrementally, and retire replaced assets.

## Output

Modernization roadmap, migration increments, and decommissioning evidence.
...
- Loop record for `loop-020-application-modernization-loop`
...
- Current state metric: To be measured for `Application Modernization Loop`
...
- Metric: Primary measurable outcome for `Application Modernization Loop`
...
```yaml
loop_id: "loop-020-application-modernization-loop"
name: "Application Modernization Loop"
version: "1.0"
...
- Loop: Application Modernization Loop
- Outcome: Modernization roadmap, migration increments, and decommissioning evidence.
- Trigger: Unsupported technology, excessive operating cost, reliability limitation, scalability constraint, or strategic platform change.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
