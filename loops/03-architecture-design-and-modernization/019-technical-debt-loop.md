...
- Loop number: 19
- Loop name: Technical Debt Loop
- Category: 3. Architecture, Design and Modernization
- Skill ID: `loop-019-technical-debt-loop`
- Version: `1.0`
...
- Minimum cadence: Continuous capture, weekly or monthly review
...
Outcome to improve: Technical-debt register, remediation decision, and trend metrics.

Primary measurable outcome: Technical-debt register, remediation decision, and trend metrics.

Business value: Improves confidence, speed, safety, and accountability for Technical Debt Loop decisions by tying every action to evidence and proof.

Risk reduced: Reduces the risk that Technical Debt Loop produces unowned gaps, stale evidence, unproven claims, unsafe actions, repeated failures, or ineffective improvements.

Scope: Architecture, Design and Modernization control point for Technical Debt Loop.
...
Systems and data covered: Systems, workflows, data, models, agents, controls, evidence, and decisions directly involved in `Technical Debt Loop`.
...
Detection of obsolete code, complexity, poor maintainability, workaround, unsupported component, or repeated delivery friction.
...
- Trigger condition: Detection of obsolete code, complexity, poor maintainability, workaround, unsupported component, or repeated delivery friction.
- Priority: To be calculated from impact, urgency, risk, and confidence
- Deduplication key: `loop-019-technical-debt-loop:<asset-or-scope>:<trigger-signature>`
...
Record debt, estimate impact and continuing cost, prioritize against business risk, remediate, and verify measurable reduction.

## Output

Technical-debt register, remediation decision, and trend metrics.
...
- Loop record for `loop-019-technical-debt-loop`
...
- Current state metric: To be measured for `Technical Debt Loop`
...
- Metric: Primary measurable outcome for `Technical Debt Loop`
...
Minimum frequency: Continuous capture, weekly or monthly review
...
```yaml
loop_id: "loop-019-technical-debt-loop"
name: "Technical Debt Loop"
version: "1.0"
...
- Loop: Technical Debt Loop
- Outcome: Technical-debt register, remediation decision, and trend metrics.
- Trigger: Detection of obsolete code, complexity, poor maintainability, workaround, unsupported component, or repeated delivery friction.
- Qualified:
- Owner:
- Evidence observed:
- Diagnosis:
